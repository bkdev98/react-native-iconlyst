...
const IconlystBackward5s2Bold = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.006 13.94h-1.867a.75.75 0 0 0 0 1.5h1.867a2.103 2.103 0 0 0 2.102-2.1c0-1.157-.944-2.1-2.103-2.1H12.89v-1.06h2.213a.75.75 0 0 0 0-1.5h-2.963a.75.75 0 0 0-.75.75v2.56c0 .415.337.75.75.75h1.867c.332 0 .601.27.601.6 0 .332-.27.6-.601.6"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystBackward5s2Bold;
