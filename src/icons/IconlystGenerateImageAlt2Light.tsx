...
const IconlystGenerateImageAlt2Light = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m20.743 13.281-5.015 2.755a2 2 0 0 1-2.309-.274l-3.728-3.395a2 2 0 0 0-2.419-.21L3 14.87M18.404 8.205l.101-.274a3.76 3.76 0 0 1 2.222-2.224L21 5.605l-.273-.1a3.76 3.76 0 0 1-2.222-2.226l-.101-.273-.101.273a3.76 3.76 0 0 1-2.222 2.225l-.273.101.273.102a3.76 3.76 0 0 1 2.222 2.224zM13.093 9.447a1.77 1.77 0 0 1 1.177-1.179 1.77 1.77 0 0 1-1.177-1.178 1.77 1.77 0 0 1-1.176 1.178 1.77 1.77 0 0 1 1.176 1.179"
    />
  </Svg>
);
export default IconlystGenerateImageAlt2Light;
