...
const IconlystRightCircleLoadOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
...
export default IconlystRightCircleLoadOutline;
