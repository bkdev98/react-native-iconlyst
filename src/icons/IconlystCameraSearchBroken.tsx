...
const IconlystCameraSearchBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M11.997 10.316a2.832 2.832 0 1 1 0 5.664 2.832 2.832 0 0 1 0-5.664"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
