...
const IconlystHeadlightsLeftStopTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M3.25 6.5h4.5M3.25 10.5h4.5M3.25 14.5h4.5M3.25 18.5h4.5M5.5 19.492a6.35 6.35 0 0 1 0-6.992 6.35 6.35 0 0 0 0-6.992"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
