...
const IconlystCloudDownloadOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.948 16.15a.75.75 0 0 1 1.06 0l2.242 2.24 2.24-2.24a.75.75 0 0 1 1.06 1.06l-2.77 2.771a.75.75 0 0 1-1.06 0L8.947 17.21a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCloudDownloadOutline;
