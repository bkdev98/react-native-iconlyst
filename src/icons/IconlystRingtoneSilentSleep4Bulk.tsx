...
const IconlystRingtoneSilentSleep4Bulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.459 8.164h3.08a.749.749 0 0 1 .556 1.254l-1.944 2.144h1.388a.75.75 0 0 1 0 1.5h-3.08a.75.75 0 0 1-.556-1.254l1.944-2.144h-1.388a.75.75 0 0 1 0-1.5"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystRingtoneSilentSleep4Bulk;
