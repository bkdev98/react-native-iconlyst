...
const IconlystTapClickTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M9.517 9.502C8.43 8.862 7.695 7.64 7.695 6.239c0-.48.086-.939.243-1.36M14.737 7a3.74 3.74 0 0 1-1.696 2.469M9.658 2.895a3.4 3.4 0 0 1 1.595-.395c1.222 0 2.3.647 2.94 1.632"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystTapClickTwoTone;
