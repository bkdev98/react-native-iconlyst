...
const IconlystBag5Outline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.14 5.649a2.97 2.97 0 0 1 2.97-2.97h2.28a2.97 2.97 0 0 1 2.97 2.97v.61a.75.75 0 0 1-1.5 0v-.61a1.47 1.47 0 0 0-1.47-1.47h-2.28c-.812 0-1.47.658-1.47 1.47v.61a.75.75 0 1 1-1.5 0zM2.504 15.791a.75.75 0 0 1 .75-.75H21.25a.75.75 0 0 1 0 1.5H3.254a.75.75 0 0 1-.75-.75M2.504 10.94a.75.75 0 0 1 .75-.75H21.25a.75.75 0 1 1 0 1.5H3.254a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystBag5Outline;
