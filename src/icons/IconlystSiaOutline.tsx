...
const IconlystSiaOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.91 12a4.34 4.34 0 1 1 8.68 0v3.59a.75.75 0 0 1-.75.75h-3.59A4.34 4.34 0 0 1 7.91 12m4.34-2.84a2.84 2.84 0 1 0 0 5.68h2.84V12a2.84 2.84 0 0 0-2.84-2.84"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystSiaOutline;
