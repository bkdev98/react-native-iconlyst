...
const IconlystCarMinusLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M17.358 13.42a3.79 3.79 0 1 1 0 7.58 3.79 3.79 0 0 1 0-7.58M16.08 17.21h2.555M14.32 11.048h1.573M6.551 11.048h1.573M3.356 7.385c5.215.74 10.509.74 15.724 0"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystCarMinusLight;
