...
const IconlystCloseSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.384 9.128a.75.75 0 0 1 1.06 0l1.803 1.803 1.801-1.801a.75.75 0 0 1 1.06 1.06l-1.8 1.801 1.807 1.807a.75.75 0 0 1-1.061 1.06l-1.807-1.806-1.8 1.8a.75.75 0 0 1-1.061-1.06l1.8-1.8-1.802-1.804a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCloseSquareOutline;
