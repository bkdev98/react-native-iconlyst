...
const IconlystIPhoneOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M5.135 14.862a.75.75 0 0 1 .75-.75h12.732a.75.75 0 0 1 0 1.5H5.885a.75.75 0 0 1-.75-.75M11.25 17.93a1 1 0 1 1 2 0 1 1 0 0 1-2 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystIPhoneOutline;
