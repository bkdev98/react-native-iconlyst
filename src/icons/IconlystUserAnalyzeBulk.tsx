...
const IconlystUserAnalyzeBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.008 13.926H8.385c-2.667 0-4.923 2.289-4.923 4.994 0 .504 0 1.105.093 1.614q.007.052.013.102c.03.19.227.365.509.365H9.8a.78.78 0 0 0 .722-.488l2.213-5.511a.784.784 0 0 0-.727-1.076"
      clipRule="evenodd"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystUserAnalyzeBulk;
