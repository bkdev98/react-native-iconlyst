...
const IconlystFolderFileUpOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.25 9.459c.199 0 .39.08.53.22l2.2 2.21a.75.75 0 1 1-1.062 1.058l-1.668-1.675-1.668 1.675a.75.75 0 0 1-1.063-1.059l2.199-2.208a.75.75 0 0 1 .531-.221"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystFolderFileUpOutline;
