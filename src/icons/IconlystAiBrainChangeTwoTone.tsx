...
const IconlystAiBrainChangeTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M9.833 7.234v4.825m0-4.825L8.498 8.521m1.335-1.287 1.334 1.287M13.814 12.442V7.617m1.334 3.539-1.335 1.287-1.334-1.287"
    />
  </Svg>
);
export default IconlystAiBrainChangeTwoTone;
