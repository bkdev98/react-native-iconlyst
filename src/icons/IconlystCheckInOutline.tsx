...
const IconlystCheckInOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M5.378 15.923a.75.75 0 0 1 .75.75c0 .94.762 1.702 1.703 1.702h2.852a.75.75 0 0 1 0 1.5H7.831a3.2 3.2 0 0 1-3.203-3.202.75.75 0 0 1 .75-.75M5.95 9.47a.75.75 0 0 1 1.062-.002l2.008 2a.75.75 0 0 1 0 1.063l-2.008 2a.75.75 0 0 1-1.059-1.062l.722-.72H2.623a.75.75 0 0 1 0-1.5h4.052l-.722-.718a.75.75 0 0 1-.002-1.06M4.628 7.327A3.2 3.2 0 0 1 7.83 4.125h2.852a.75.75 0 0 1 0 1.5H7.831c-.941 0-1.703.763-1.703 1.702a.75.75 0 0 1-1.5 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCheckInOutline;
