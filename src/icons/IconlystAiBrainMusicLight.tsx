...
const IconlystAiBrainMusicLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M9.066 11.439a1.48 1.48 0 1 0 0-2.964 1.482 1.482 0 0 0 0 2.964"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m10.547 9.957.001-3.648s.385 1 1.421 1.212M13.106 15.382a1.136 1.136 0 1 0 0-2.27 1.136 1.136 0 0 0 0 2.27"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M14.242 14.246v-3.242s.343.89 1.263 1.077"
    />
  </Svg>
);
export default IconlystAiBrainMusicLight;
