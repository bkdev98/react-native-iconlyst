...
const IconlystAiBrainSettingTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M11.846 6.617v1.184m0 4.736v1.184m-3.08-5.328 1.023.592m4.113 2.369 1.02.592m-6.155 0 1.022-.592m4.113-2.369 1.02-.592m-1.403.1a2.368 2.368 0 1 1-3.348 3.35 2.368 2.368 0 0 1 3.348-3.35"
    />
  </Svg>
);
