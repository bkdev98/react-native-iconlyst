...
const IconlystDcoumentBarChartLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M14.77 3.182v2.892a2.56 2.56 0 0 0 2.554 2.56h2.738M15.33 15.772v-3.696M9.67 15.772v-5.051M12.5 15.772v-1.886"
    />
  </Svg>
);
export default IconlystDcoumentBarChartLight;
