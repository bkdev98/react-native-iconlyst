...
const IconlystLyricsOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.85 16.377a.75.75 0 0 1 .75-.75h1.31a.75.75 0 1 1 0 1.5H7.6a.75.75 0 0 1-.75-.75M10.86 16.377a.75.75 0 0 1 .75-.75h5.288a.75.75 0 1 1 0 1.5H11.61a.75.75 0 0 1-.75-.75M13.8 12.654a.75.75 0 0 1 .75-.75h2.347a.75.75 0 0 1 0 1.5H14.55a.75.75 0 0 1-.75-.75M6.908 12.654a.75.75 0 0 1 .75-.75h4.185a.75.75 0 0 1 0 1.5H7.658a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystLyricsOutline;
