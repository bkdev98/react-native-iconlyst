...
const IconlystAirpodsDisconnectedBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M17.749 21.5a4.209 4.209 0 1 0 0-8.417 4.209 4.209 0 0 0 0 8.417m-.525-5.788a.745.745 0 1 0-1.054 1.053l.525.525-.525.525a.745.745 0 1 0 1.054 1.054l.524-.525.524.525a.745.745 0 1 0 1.054-1.054l-.525-.525.525-.524a.745.745 0 0 0-1.054-1.054l-.524.524z"
      clipRule="evenodd"
    />
...
export default IconlystAirpodsDisconnectedBulk;
