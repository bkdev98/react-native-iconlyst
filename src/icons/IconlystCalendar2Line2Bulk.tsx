...
const IconlystCalendar2Line2Bulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.76 11.885H8.3a.749.749 0 1 1 0-1.5h7.46a.749.749 0 1 1 0 1.5m-3.14 4.17H8.3a.749.749 0 1 1 0-1.5h4.32c.42 0 .75.34.75.75 0 .42-.33.75-.75.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCalendar2Line2Bulk;
