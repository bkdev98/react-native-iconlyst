...
const IconlystBackward5sBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.059 13.87h-1.881a.75.75 0 0 0 0 1.5h1.88a2.113 2.113 0 0 0 2.113-2.109 2.114 2.114 0 0 0-2.112-2.11h-1.131v-1.08h2.234a.75.75 0 0 0 0-1.5h-2.984a.75.75 0 0 0-.75.75v2.58c0 .413.336.75.75.75h1.88c.338 0 .613.273.613.61a.61.61 0 0 1-.612.61"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystBackward5sBulk;
