...
const IconlystElevatorBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M7.008 9.3a.75.75 0 0 0 0 1.5h2.15l3.663 4.03a.75.75 0 0 0 .555.246h3.407a.75.75 0 0 0 0-1.5h-3.075l-3.664-4.03a.75.75 0 0 0-.555-.245zM14.743 9.3a.75.75 0 0 0 0 1.5h2.25a.75.75 0 0 0 0-1.5z"
    />
  </Svg>
);
export default IconlystElevatorBulk;
