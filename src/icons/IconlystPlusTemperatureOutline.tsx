...
const IconlystPlusTemperatureOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.856 5.978a.75.75 0 0 1 .75.75v7.799a.75.75 0 1 1-1.5 0v-7.8a.75.75 0 0 1 .75-.75M15.542 7.888a.75.75 0 0 1 .75-.75h4.079a.75.75 0 0 1 0 1.5h-4.079a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M18.331 5.1a.75.75 0 0 1 .75.75v4.078a.75.75 0 0 1-1.5 0V5.849a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystPlusTemperatureOutline;
