...
const IconlystPoopSadLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M11.402 16.488c.4-.452.92-.777 1.596-.784.706-.008 1.214.327 1.639.784"
    />
  </Svg>
);
export default IconlystPoopSadLight;
