...
const IconlystDeliveryAddPlusBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="m10.46 9.518 1.865-.615a.75.75 0 0 1 .467-.001l1.848.6-.014-6.802a.3.3 0 0 0-.3-.3l-3.574.009a.3.3 0 0 0-.299.3zM19.238 21.598a.75.75 0 0 1-.75-.75v-1.91h-1.91a.75.75 0 0 1 0-1.5h1.91v-1.91a.75.75 0 0 1 1.5 0v1.91h1.91a.75.75 0 0 1 0 1.5h-1.91v1.91a.75.75 0 0 1-.75.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDeliveryAddPlusBulk;
