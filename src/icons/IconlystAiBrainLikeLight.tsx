...
const IconlystAiBrainLikeLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M9.5 7.073c-1.182.38-1.602 1.665-1.242 2.791.58 1.804 3.065 3.157 3.065 3.157s2.505-1.374 3.066-3.157c.36-1.126-.065-2.41-1.246-2.791a2.03 2.03 0 0 0-1.82.306A2.02 2.02 0 0 0 9.5 7.073"
    />
  </Svg>
);
export default IconlystAiBrainLikeLight;
