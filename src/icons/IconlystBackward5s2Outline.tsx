...
const IconlystBackward5s2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M2.554 9.935a.75.75 0 0 1 1.06 0l1.122 1.121 1.112-1.112a.75.75 0 0 1 1.06 1.06l-1.642 1.643a.75.75 0 0 1-1.06 0l-1.652-1.652a.75.75 0 0 1 0-1.06M10.703 9.43a.75.75 0 0 1 .75-.75h2.962a.75.75 0 0 1 0 1.5h-2.212v1.057h1.116a2.102 2.102 0 0 1 0 4.203h-1.866a.75.75 0 0 1 0-1.5h1.866a.602.602 0 0 0 0-1.203h-1.866a.75.75 0 0 1-.75-.75z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystBackward5s2Outline;
