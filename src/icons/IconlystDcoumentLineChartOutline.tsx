...
const IconlystDcoumentLineChartOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.77 2.432a.75.75 0 0 1 .75.75v2.892a1.81 1.81 0 0 0 1.805 1.81h2.738a.75.75 0 0 1 0 1.5h-2.741a3.31 3.31 0 0 1-3.302-3.31V3.182a.75.75 0 0 1 .75-.75M16.381 11.525a.75.75 0 0 1 .136 1.052l-2.147 2.787a.75.75 0 0 1-1.059.131l-1.907-1.504-1.732 2.262a.75.75 0 1 1-1.191-.911l2.195-2.867a.75.75 0 0 1 1.06-.133l1.909 1.506 1.684-2.187a.75.75 0 0 1 1.052-.136"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystDcoumentLineChartOutline;
