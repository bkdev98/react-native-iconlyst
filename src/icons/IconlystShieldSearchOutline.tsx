...
const IconlystShieldSearchOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M11.62 9.713a2.158 2.158 0 1 0 .002 4.315 2.158 2.158 0 0 0-.001-4.315M7.965 11.87a3.658 3.658 0 1 1 6.658 2.091l.97.968a.75.75 0 1 1-1.059 1.062L13.53 14.99a3.657 3.657 0 0 1-5.566-3.12"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystShieldSearchOutline;
