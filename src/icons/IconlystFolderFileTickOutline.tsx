...
const IconlystFolderFileTickOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.863 10.612a.75.75 0 0 1 0 1.06l-4.14 4.143a.75.75 0 0 1-1.062 0L8.638 13.79a.75.75 0 0 1 1.06-1.06l1.494 1.493 3.61-3.612a.75.75 0 0 1 1.06 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileTickOutline;
