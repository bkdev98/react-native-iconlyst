...
const IconlystPaperFailOutlinecurved = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.184 2.083a.75.75 0 0 1 .75.75v2.66a2.613 2.613 0 0 0 2.614 2.614H20.5a.75.75 0 0 1 0 1.5h-2.95a4.113 4.113 0 0 1-4.115-4.113V2.833a.75.75 0 0 1 .75-.75M9.849 10.718a.75.75 0 0 1 1.06 0l3.467 3.466a.75.75 0 1 1-1.061 1.06L9.849 11.78a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.376 10.718a.75.75 0 0 1 0 1.06l-3.466 3.467a.75.75 0 0 1-1.06-1.06l3.466-3.467a.75.75 0 0 1 1.06 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystPaperFailOutlinecurved;
