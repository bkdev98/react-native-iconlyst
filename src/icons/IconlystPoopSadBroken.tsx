...
const IconlystPoopSadBroken = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M10.576 12.295v.01M15.45 12.295v.01M11.402 16.487c.4-.452.92-.777 1.596-.784.706-.008 1.214.327 1.639.784"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystPoopSadBroken;
