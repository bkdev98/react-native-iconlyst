...
const IconlystHeartTickOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.481 8.493a.75.75 0 0 1 0 1.06l-3.635 3.638a.75.75 0 0 1-1.06 0L9.02 11.424a.75.75 0 0 1 1.061-1.06l1.235 1.235 3.104-3.106a.75.75 0 0 1 1.061 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystHeartTickOutline;
