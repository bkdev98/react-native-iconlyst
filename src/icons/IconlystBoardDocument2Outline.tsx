...
const IconlystBoardDocument2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M11.477 8.629a.75.75 0 0 1 .75-.75h4.014a.75.75 0 1 1 0 1.5h-4.014a.75.75 0 0 1-.75-.75m0 4.345a.75.75 0 0 1 .75-.75h2.12a.75.75 0 0 1 0 1.5h-2.12a.75.75 0 0 1-.75-.75M8.137 2.25a.75.75 0 0 1 .75.75v18a.75.75 0 0 1-1.5 0V3a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystBoardDocument2Outline;
