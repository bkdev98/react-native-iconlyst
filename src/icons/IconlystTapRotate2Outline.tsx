...
const IconlystTapRotate2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M5.882 5.497a.75.75 0 0 1-.495.938 1.763 1.763 0 1 0 1.506.223.75.75 0 0 1 .84-1.242 3.262 3.262 0 1 1-2.79-.413.75.75 0 0 1 .939.494"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M2.88 5.307c0 .414.336.75.75.75h.783v.782a.75.75 0 1 0 1.5 0V5.307a.75.75 0 0 0-.75-.75H3.63a.75.75 0 0 0-.75.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystTapRotate2Outline;
