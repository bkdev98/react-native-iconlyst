...
const IconlystAiBrainHelpTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M6.14 9.531v.007M6.138 7.485c-.01-.746.67-1.063 1.175-1.352.616-.34 1.033-.88 1.033-1.63A2 2 0 0 0 6.344 2.5 1.997 1.997 0 0 0 4.34 4.504"
    />
    <G
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystAiBrainHelpTwoTone;
