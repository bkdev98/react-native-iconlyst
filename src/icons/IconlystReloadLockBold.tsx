...
const IconlystReloadLockBold = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.103 10.64c0-1.16-.94-2.1-2.103-2.1-1.162 0-2.103.94-2.103 2.1 0 .69.34 1.3.86 1.69l-.652 1.96a.89.89 0 0 0 .845 1.17h2.1c.607 0 1.036-.6.844-1.17l-.65-1.96c.518-.39.86-1 .86-1.69"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystReloadLockBold;
