...
const IconlystImageCloseBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M21 10.953v5.023c0 2.944-1.844 5.021-4.788 5.021h-4.217M20.786 3.67l-3.687 3.687M20.788 7.357 17.1 3.671"
    />
  </Svg>
);
export default IconlystImageCloseBroken;
