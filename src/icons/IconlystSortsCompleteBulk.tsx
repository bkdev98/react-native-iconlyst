...
const IconlystSortsCompleteBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <G fill={props.color} fillRule="evenodd" clipRule="evenodd" opacity={0.4}>
      <Path d="M20 17.059h-8.727a1 1 0 1 0 0 2H20a1 1 0 1 0 0-2M20 11.242h-8.727a1 1 0 1 0 0 2H20a1 1 0 1 0 0-2M11.273 7.422H20a1 1 0 1 0 0-2h-8.728a1 1 0 1 0 0 2" />
    </G>
  </Svg>
);
export default IconlystSortsCompleteBulk;
