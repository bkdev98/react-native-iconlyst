...
const IconlystCorrectTextOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M17.962 10.317a.75.75 0 0 1 0 1.06l-3.835 3.837a.75.75 0 0 1-1.061 0l-2.034-2.032a.75.75 0 0 1 1.06-1.06l1.504 1.502 3.305-3.307a.75.75 0 0 1 1.06 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCorrectTextOutline;
