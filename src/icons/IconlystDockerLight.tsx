...
const IconlystDockerLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M5.135 18.236c.713.152 2.34 0 3.377-1.197M6.938 11.997V7.22h5.03"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M4.407 11.996v-2.23h10.124v2.23"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M9.469 11.998v-7.44h2.53v7.44M10.011 15.047h-.01"
    />
  </Svg>
);
export default IconlystDockerLight;
