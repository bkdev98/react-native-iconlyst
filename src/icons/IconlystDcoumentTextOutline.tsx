...
const IconlystDcoumentTextOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M15.193 13.327a.75.75 0 0 1-.75-.75v-.722h-4.384v.722a.75.75 0 1 1-1.5 0V11.6a1.24 1.24 0 0 1 1.24-1.24h4.9a1.24 1.24 0 0 1 1.24 1.24v.981a.75.75 0 0 1-.746.746"
    />
    <Path
      fill={props.color}
      d="M12.251 17.74h-1.47a.75.75 0 0 1 0-1.5h.72v-5.134a.75.75 0 0 1 1.5 0v5.135h.723a.75.75 0 1 1 0 1.5z"
    />
    <Path
      fill={props.color}
...
export default IconlystDcoumentTextOutline;
