...
const IconlystFolderFileSearchOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M13.093 11.666a1.757 1.757 0 1 0-2.483 2.486 1.757 1.757 0 0 0 2.483-2.486m-3.544-1.06a3.257 3.257 0 0 1 5.074 4.013l.89.888a.75.75 0 1 1-1.061 1.061l-.89-.889a3.257 3.257 0 0 1-4.013-5.074"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileSearchOutline;
