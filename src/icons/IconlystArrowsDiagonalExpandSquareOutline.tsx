...
const IconlystArrowsDiagonalExpandSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.346 8.25a.75.75 0 1 1 0-1.5H16.5a.75.75 0 0 1 .75.75v4.154a.75.75 0 1 1-1.5 0V9.31L9.31 15.75h2.344a.75.75 0 1 1 0 1.5H7.5a.75.75 0 0 1-.75-.75v-4.154a.75.75 0 1 1 1.5 0v2.343l6.44-6.439z"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystArrowsDiagonalExpandSquareOutline;
