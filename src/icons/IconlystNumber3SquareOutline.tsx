...
const IconlystNumber3SquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.75 10.382a2.75 2.75 0 1 1 4.637 2 2.75 2.75 0 1 1-4.637 2 .75.75 0 0 1 1.5 0 1.25 1.25 0 1 0 1.25-1.25.75.75 0 0 1 0-1.5 1.25 1.25 0 1 0-1.25-1.25.75.75 0 0 1-1.5 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystNumber3SquareOutline;
