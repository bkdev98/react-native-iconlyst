...
const IconlystVerticalMirrorOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M5.56 10.29c0-.991 1.148-1.54 1.92-.92l2.13 1.708c.59.473.59 1.37.001 1.843l-2.13 1.708c-.773.62-1.92.07-1.92-.921zm1.5.665 1.303 1.044-1.302 1.045zM12.252 2.25a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-1.5 0V3a.75.75 0 0 1 .75-.75m0 5.333a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-1.5 0v-2a.75.75 0 0 1 .75-.75m0 5.334a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-1.5 0v-2a.75.75 0 0 1 .75-.75m0 5.333a.75.75 0 0 1 .75.75v2a.75.75 0 0 1-1.5 0v-2a.75.75 0 0 1 .75-.75M17.024 9.37c.772-.62 1.92-.071 1.92.92v3.418c0 .992-1.148 1.54-1.92.921l-2.13-1.708a1.18 1.18 0 0 1 0-1.843zm.42 1.585-1.302 1.044 1.302 1.045z"
      clipRule="evenodd"
    />
  </Svg>
);
