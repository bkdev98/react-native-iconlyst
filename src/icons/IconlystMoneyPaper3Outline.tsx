...
const IconlystMoneyPaper3Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.929 14.543a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0v-.01a.75.75 0 0 1 .75-.75M17.571 7.95a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0V8.7a.75.75 0 0 1 .75-.75M9.213 12a3.038 3.038 0 1 1 6.075 0 3.038 3.038 0 0 1-6.075 0m3.038-1.537a1.538 1.538 0 1 0-.001 3.075 1.538 1.538 0 0 0 .001-3.075"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystMoneyPaper3Outline;
