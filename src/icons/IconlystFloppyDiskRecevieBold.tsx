...
const IconlystFloppyDiskRecevieBold = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.626 17.632h-4.222c-.597 0-1.083.486-1.083 1.084V21.3c0 .11.09.2.2.2h5.988a.2.2 0 0 0 .2-.2v-2.584c0-.598-.485-1.084-1.083-1.084"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.457 12.677a.75.75 0 1 0 1.061 1.061l1.967-1.97a.76.76 0 0 0 .162-.817.8.8 0 0 0-.162-.243L8.518 8.74a.75.75 0 1 0-1.06 1.061l.686.687H2.736a.75.75 0 0 0 0 1.5h5.41z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFloppyDiskRecevieBold;
