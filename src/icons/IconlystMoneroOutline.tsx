...
const IconlystMoneroOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.643 7.51a.75.75 0 0 1 .817.163l4.79 4.791 4.8-4.792a.75.75 0 0 1 1.28.531v6.705h2.881a.75.75 0 0 1 0 1.5h-3.63a.75.75 0 0 1-.75-.75v-5.646l-4.051 4.043a.75.75 0 0 1-1.06 0l-4.04-4.041v5.644a.75.75 0 0 1-.75.75H3.29a.75.75 0 0 1 0-1.5h2.89V8.203a.75.75 0 0 1 .463-.693"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystMoneroOutline;
