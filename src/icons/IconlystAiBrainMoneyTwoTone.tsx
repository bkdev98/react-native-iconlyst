...
const IconlystAiBrainMoneyTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M8.263 3.318H6.018a1.209 1.209 0 1 0 0 2.418h1.381a1.209 1.209 0 1 1 0 2.419H5.154M6.708 8.154v1.015m0-6.872V3.32"
    />
    <G
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystAiBrainMoneyTwoTone;
