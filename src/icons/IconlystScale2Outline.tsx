...
const IconlystScale2Outline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.25 15.743a.75.75 0 0 1 .75.75v4.365a.75.75 0 0 1-1.5 0v-4.365a.75.75 0 0 1 .75-.75M6.676 11.75a5.575 5.575 0 1 1 11.15 0 .75.75 0 0 1-.75.75h-9.65a.75.75 0 0 1-.75-.75M8.245 11h8.012a4.076 4.076 0 0 0-8.012 0"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.25 8.978a.75.75 0 0 1 .75.75v2.022a.75.75 0 0 1-1.5 0V9.728a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystScale2Outline;
