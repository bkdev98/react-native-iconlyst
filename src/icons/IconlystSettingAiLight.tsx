...
const IconlystSettingAiLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m10.206 13.824-.093-.252a3.47 3.47 0 0 0-2.047-2.051l-.252-.093.252-.094a3.47 3.47 0 0 0 2.047-2.05l.093-.252.094.252c.35.95 1.099 1.699 2.047 2.05l.252.094-.252.093a3.47 3.47 0 0 0-2.047 2.05zM15.102 14.969a1.63 1.63 0 0 0-1.085-1.087c.52-.158.926-.566 1.085-1.086.158.52.564.928 1.084 1.086a1.63 1.63 0 0 0-1.085 1.087"
    />
  </Svg>
);
export default IconlystSettingAiLight;
