...
const IconlystDoubleDownSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.47 12.97a.75.75 0 0 1 1.06 0L12 15.44l2.47-2.47a.75.75 0 0 1 1.06 1.06l-2.999 3a.75.75 0 0 1-1.06 0l-3.001-3a.75.75 0 0 1 0-1.06M8.47 7.72a.75.75 0 0 1 1.06 0L12 10.19l2.47-2.47a.75.75 0 0 1 1.06 1.06l-2.999 3a.75.75 0 0 1-1.06 0l-3.001-3a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystDoubleDownSquareOutline;
