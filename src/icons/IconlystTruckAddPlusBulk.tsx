...
const IconlystTruckAddPlusBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.88 3.137a4.615 4.615 0 0 0-4.61 4.61 4.608 4.608 0 0 0 9.215 0 4.613 4.613 0 0 0-4.605-4.61"
      clipRule="evenodd"
      opacity={0.4}
    />
    <Path
      fill={props.color}
      d="M7.63 8.497h.692a.75.75 0 0 0 0-1.5H7.63v-.694a.75.75 0 0 0-1.5 0v.694h-.694a.75.75 0 0 0 0 1.5h.694v.695a.75.75 0 0 0 1.5 0z"
    />
  </Svg>
);
export default IconlystTruckAddPlusBulk;
