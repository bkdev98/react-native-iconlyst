...
const IconlystAiBrainHelpLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M5.64 9.531v.007M5.638 7.485c-.01-.746.67-1.063 1.175-1.352.616-.34 1.034-.88 1.034-1.63A2 2 0 0 0 5.844 2.5 1.997 1.997 0 0 0 3.84 4.504"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystAiBrainHelpLight;
