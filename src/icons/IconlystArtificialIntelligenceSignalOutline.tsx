...
const IconlystArtificialIntelligenceSignalOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12 8.572a.75.75 0 0 1 .75.75v5.355a.75.75 0 0 1-1.5 0V9.322a.75.75 0 0 1 .75-.75m-2.983 2.009a.75.75 0 0 1 .75.75v3.346a.75.75 0 1 1-1.5 0v-3.346a.75.75 0 0 1 .75-.75m5.966 1.774a.75.75 0 0 1 .75.75v1.572a.75.75 0 0 1-1.5 0v-1.572a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystArtificialIntelligenceSignalOutline;
