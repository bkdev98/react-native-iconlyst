...
const IconlystCloudBrainLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M13.027 12.181h.384c.192 0 .444-.037.7-.14a1.74 1.74 0 0 0 1.02-1.582c0-1.087-.768-1.726-1.718-1.734 0-.684-.537-2.051-2.051-2.051S9.31 8.04 9.31 8.724c-.95.009-1.718.648-1.718 1.735 0 .703.418 1.308 1.02 1.58.707.32 1.722.327 1.722 1.955v7.484"
    />
  </Svg>
);
export default IconlystCloudBrainLight;
