...
const IconlystRingtoneRemove2Bulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M11.044 8.74a.75.75 0 0 0-1.06 1.06l.956.956-.957.957a.75.75 0 0 0 1.061 1.06l.956-.956.956.955a.75.75 0 0 0 1.06-1.06l-.955-.956.955-.955a.75.75 0 1 0-1.06-1.06L12 9.695z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystRingtoneRemove2Bulk;
