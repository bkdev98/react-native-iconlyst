...
const IconlystCalendarStickerAddOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M17.358 14.371h2.9219999999999997a.75.75 0 1 1 0 1.5h-2.919a1.98 1.98 0 0 0-1.974 1.98v3.086a.75.75 0 0 1-1.5 0v-3.085a3.48 3.48 0 0 1 3.471-3.48M8.62 2.25a.75.75 0 0 1 .75.75v2.962a.75.75 0 0 1-1.5 0V3a.75.75 0 0 1 .75-.75m7.27 0a.75.75 0 0 1 .75.75v2.962a.75.75 0 0 1-1.5 0V3a.75.75 0 0 1 .75-.75M11.889 9.46a.75.75 0 0 1 .75.75v1.41h1.408a.75.75 0 0 1 0 1.5h-1.408v1.407a.75.75 0 0 1-1.5 0V13.12H9.73a.75.75 0 0 1 0-1.5h1.409v-1.41a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCalendarStickerAddOutline;
