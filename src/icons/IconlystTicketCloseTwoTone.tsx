...
const IconlystTicketCloseTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m16.862 18.339 2.01-2.01m0 2.01-2.01-2.01"
    />
    <Circle
      cx={17.868}
      cy={17.335}
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m13.895 9.55 1.763 1.764M10.135 5.813l1.737 1.737"
    />
  </Svg>
);
export default IconlystTicketCloseTwoTone;
