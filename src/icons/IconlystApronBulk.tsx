...
const IconlystApronBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M8.933 14.381a3.068 3.068 0 1 0 6.135 0v-.43c0-.565-.457-1.023-1.022-1.023h-4.09c-.566 0-1.023.458-1.023 1.022z"
    />
  </Svg>
);
export default IconlystApronBulk;
