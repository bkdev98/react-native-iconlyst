...
const IconlystAiChipLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m7.942 14.741 2.399-5.483 2.468 5.483"
    />
    <Path stroke={props.color} strokeWidth={1.5} d="M8.584 13.33h3.582" />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M15.455 14.74V9.46"
    />
  </Svg>
);
export default IconlystAiChipLight;
