...
const IconlystSafeBatteryTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M17.316 10.27v-.704c0-2.539-1.452-4.124-4.104-4.124h-3.35c-2.61 0-4.03 1.585-4.03 4.124v7.319c0 2.546 1.42 4.123 4.03 4.115h1.09"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystSafeBatteryTwoTone;
