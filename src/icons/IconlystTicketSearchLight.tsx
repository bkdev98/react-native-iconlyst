...
const IconlystTicketSearchLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M13.8 15.304a3.21 3.21 0 0 0 5.475 2.27c.58-.59.937-1.386.937-2.27a3.205 3.205 0 1 0-6.411 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystTicketSearchLight;
