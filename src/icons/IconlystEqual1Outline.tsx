...
const IconlystEqual1Outline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M15.36 9.596a.75.75 0 0 1-.75.75H9.393a.75.75 0 1 1 0-1.5h5.219a.75.75 0 0 1 .75.75M15.36 13.905a.75.75 0 0 1-.75.75H9.393a.75.75 0 0 1 0-1.5h5.219a.75.75 0 0 1 .75.75"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
...
export default IconlystEqual1Outline;
