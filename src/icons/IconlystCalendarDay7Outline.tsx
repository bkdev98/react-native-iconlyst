...
const IconlystCalendarDay7Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.988 10.893a.75.75 0 0 1 .75-.75h3.377a.75.75 0 0 1 .716.972L13.17 16.47a.75.75 0 1 1-1.433-.445l1.361-4.382h-2.359a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCalendarDay7Outline;
