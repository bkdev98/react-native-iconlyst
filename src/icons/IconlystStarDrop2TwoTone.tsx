...
const IconlystStarDrop2TwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M6.363 4.944v1.777M18.633 4.944v4.237M12.5 3.916v1.35"
    />
  </Svg>
);
export default IconlystStarDrop2TwoTone;
