...
const IconlystForward5s2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M21.614 9.935a.75.75 0 0 1 0 1.06l-1.652 1.652a.75.75 0 0 1-1.06 0l-1.643-1.642a.75.75 0 1 1 1.06-1.06l1.113 1.111 1.121-1.121a.75.75 0 0 1 1.06 0M8.746 9.43a.75.75 0 0 1 .75-.75h2.962a.75.75 0 0 1 0 1.5h-2.212v1.057h1.116a2.102 2.102 0 0 1 0 4.203H9.496a.75.75 0 1 1 0-1.5h1.866a.602.602 0 0 0 0-1.203H9.496a.75.75 0 0 1-.75-.75z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystForward5s2Outline;
