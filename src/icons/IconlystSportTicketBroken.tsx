...
const IconlystSportTicketBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M8.377 11.14a3.967 3.967 0 1 0 1.68-2.445"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M12.676 8.13q.014.17.014.343a3.967 3.967 0 0 1-4.348 3.949M11.827 15.903a3.967 3.967 0 0 1 4.273-4.33"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystSportTicketBroken;
