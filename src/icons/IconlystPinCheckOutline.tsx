...
const IconlystPinCheckOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.963 7.915a.75.75 0 0 1 0 1.06l-4.032 4.035a.75.75 0 0 1-1.062 0l-1.957-1.96a.75.75 0 0 1 1.062-1.06l1.426 1.429 3.502-3.504a.75.75 0 0 1 1.061 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystPinCheckOutline;
