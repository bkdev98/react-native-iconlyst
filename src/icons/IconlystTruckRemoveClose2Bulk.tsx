...
const IconlystTruckRemoveClose2Bulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M8.429 9.299a.75.75 0 0 0 0-1.061l-.49-.49.492-.491A.75.75 0 1 0 7.37 6.196l-.491.492-.491-.491a.75.75 0 1 0-1.061 1.061l.49.49-.49.49A.75.75 0 1 0 6.387 9.3l.492-.491.489.49a.75.75 0 0 0 1.06 0"
    />
  </Svg>
);
export default IconlystTruckRemoveClose2Bulk;
