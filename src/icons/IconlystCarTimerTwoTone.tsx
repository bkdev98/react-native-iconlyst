...
const IconlystCarTimerTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M17.358 21a3.79 3.79 0 1 1 0-7.58 3.79 3.79 0 0 1 0 7.58"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M17.268 15.933v1.477l1.164.71M14.32 11.048h1.573M6.551 11.048h1.573M3.356 7.385c5.215.74 10.509.74 15.724 0"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
...
export default IconlystCarTimerTwoTone;
