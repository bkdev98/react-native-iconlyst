...
const IconlystStarMagicLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m18.184 19.198 2.535 2.718"
    />
  </Svg>
);
export default IconlystStarMagicLight;
