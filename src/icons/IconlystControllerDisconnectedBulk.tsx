...
const IconlystControllerDisconnectedBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
...
export default IconlystControllerDisconnectedBulk;
