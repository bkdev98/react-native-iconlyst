...
const IconlystDcoumentDownloadBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="m13.689 14.15-2.268 2.278a.747.747 0 0 1-1.091.036l-.003-.003-2.301-2.31a.751.751 0 0 1 1.063-1.06l1.02 1.025v-4.108a.75.75 0 0 1 1.5 0v4.106l1.018-1.022a.75.75 0 0 1 1.062 1.059M17.016 7.672c.673.007 1.608.01 2.4.007a.465.465 0 0 0 .332-.787c-.51-.534-1.218-1.28-1.93-2.027l-1.955-2.053a.46.46 0 0 0-.793.325v2.569c0 1.078.879 1.966 1.946 1.966"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDcoumentDownloadBulk;
