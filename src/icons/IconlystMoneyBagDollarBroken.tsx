...
const IconlystMoneyBagDollarBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M13.37 12.332h-1.978a1.065 1.065 0 1 0 0 2.132h1.218a1.065 1.065 0 1 1 0 2.13h-1.98M12 16.596v.895m0-6.057v.902M11.242 8.318q1.957.108 3.916-.341"
    />
  </Svg>
);
export default IconlystMoneyBagDollarBroken;
