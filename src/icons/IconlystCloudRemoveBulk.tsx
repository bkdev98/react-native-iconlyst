...
const IconlystCloudRemoveBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.17 14.54a.75.75 0 0 0-1.06 0l-1.596 1.595-1.595-1.595a.75.75 0 0 0-1.06 1.061l1.595 1.595-1.596 1.595a.752.752 0 0 0 .531 1.281.75.75 0 0 0 .53-.22l1.595-1.595 1.595 1.595a.75.75 0 0 0 1.061 0 .75.75 0 0 0 0-1.06l-1.595-1.596 1.595-1.595a.75.75 0 0 0 0-1.06"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCloudRemoveBulk;
