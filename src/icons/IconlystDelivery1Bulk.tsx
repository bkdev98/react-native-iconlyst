...
const IconlystDelivery1Bulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="m10.762 9.623 1.864-.615a.75.75 0 0 1 .467 0l1.848.6-.014-6.803a.3.3 0 0 0-.3-.3l-3.574.01a.3.3 0 0 0-.3.3z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDelivery1Bulk;
