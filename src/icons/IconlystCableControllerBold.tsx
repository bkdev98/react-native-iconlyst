...
const IconlystCableControllerBold = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.189 5.291h.9c.56 0 1.05.444 1.05.95v.7a.75.75 0 0 0 1.5 0v-.7c0-1.328-1.168-2.45-2.55-2.45h-.9a.36.36 0 0 1-.35-.35.75.75 0 0 0-1.5 0c0 1.02.83 1.85 1.85 1.85"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystCableControllerBold;
