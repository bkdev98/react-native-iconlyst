...
const IconlystOldTvAntennaOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M17.36 2.705a.75.75 0 0 1-.059 1.059l-4.552 4.075a.75.75 0 0 1-1.008-.007L7.303 3.758a.75.75 0 1 1 1.015-1.105l3.937 3.615L16.3 2.646a.75.75 0 0 1 1.059.059"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystOldTvAntennaOutline;
