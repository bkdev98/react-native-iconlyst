...
const IconlystReactNativeTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M8.059 11.998c.27-.578.57-1.163.91-1.75 2.485-4.305 5.857-7.01 7.53-6.044 1.048.604 1.183 2.501.53 4.89"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M12 11.99v.05m.204-.04a.204.204 0 1 1-.408 0 .204.204 0 0 1 .408 0"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystReactNativeTwoTone;
