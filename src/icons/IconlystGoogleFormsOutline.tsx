...
const IconlystGoogleFormsOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.04 11.367a.75.75 0 0 1 .75-.75h4.722a.75.75 0 0 1 0 1.5H10.79a.75.75 0 0 1-.75-.75m0 2.7a.75.75 0 0 1 .75-.75h4.722a.75.75 0 0 1 0 1.5H10.79a.75.75 0 0 1-.75-.75m0 2.7a.75.75 0 0 1 .75-.75h4.722a.75.75 0 0 1 0 1.5H10.79a.75.75 0 0 1-.75-.75M9.247 11.367a.75.75 0 0 0-.75-.75h-.01a.75.75 0 0 0 0 1.5h.01a.75.75 0 0 0 .75-.75m0 2.7a.75.75 0 0 0-.75-.75h-.01a.75.75 0 0 0 0 1.5h.01a.75.75 0 0 0 .75-.75m0 2.7a.75.75 0 0 0-.75-.75h-.01a.75.75 0 0 0 0 1.5h.01a.75.75 0 0 0 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystGoogleFormsOutline;
