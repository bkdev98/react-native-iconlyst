...
const IconlystHeadlightsLeftShortOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.134 6.178a.75.75 0 0 1-.356 1l-4.206 2a.75.75 0 0 1-.644-1.355l4.206-2a.75.75 0 0 1 1 .355M8.134 10.178a.75.75 0 0 1-.356 1l-4.206 2a.75.75 0 1 1-.644-1.355l4.206-2a.75.75 0 0 1 1 .355M8.134 14.178a.75.75 0 0 1-.356 1l-4.206 2a.75.75 0 1 1-.644-1.355l4.206-2a.75.75 0 0 1 1 .355M8.134 18.178a.75.75 0 0 1-.356 1l-4.206 2a.75.75 0 1 1-.644-1.355l4.206-2a.75.75 0 0 1 1 .355"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystHeadlightsLeftShortOutline;
