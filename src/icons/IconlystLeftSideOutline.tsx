...
const IconlystLeftSideOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.792 2.25a.75.75 0 0 1 .75.75v18a.75.75 0 0 1-1.5 0V3a.75.75 0 0 1 .75-.75M16.448 8.884a.75.75 0 0 1-.039 1.06l-2.212 2.054 2.212 2.054a.75.75 0 0 1-1.02 1.1l-2.805-2.604a.75.75 0 0 1 0-1.1l2.805-2.603a.75.75 0 0 1 1.06.04"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystLeftSideOutline;
