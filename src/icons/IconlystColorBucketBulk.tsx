...
const IconlystColorBucketBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M21.87 17.679c-.71-1.05-1.76-1.75-1.8-1.78a.74.74 0 0 0-.83 0c-.05.03-1.1.73-1.82 1.8-.48.78-.49 1.84-.01 2.7.46.83 1.3 1.32 2.24 1.32.95 0 1.78-.49 2.25-1.32.47-.86.47-1.92-.03-2.72"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystColorBucketBulk;
