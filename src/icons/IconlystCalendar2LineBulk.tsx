...
const IconlystCalendar2LineBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.8 16.055H8.34a.749.749 0 1 1 0-1.5h7.46a.749.749 0 1 1 0 1.5m-7.46-5.67h4.32c.42 0 .75.34.75.75 0 .42-.33.75-.75.75H8.34a.749.749 0 1 1 0-1.5"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCalendar2LineBulk;
