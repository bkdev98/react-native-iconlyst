...
const IconlystNewMassage3HeartBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M20.185 2.566a2.26 2.26 0 0 0-1.716.153 2.25 2.25 0 0 0-1.724-.152c-1.201.387-1.813 1.72-1.394 3.033v.001c.556 1.724 2.784 2.953 2.879 3.005a.5.5 0 0 0 .479 0c.096-.054 2.339-1.3 2.875-3.006.42-1.313-.192-2.645-1.4-3.034M12.76 16.372H7.922a.75.75 0 0 1 0-1.5h4.836a.75.75 0 0 1 0 1.5M7.922 10.62h1.974a.75.75 0 0 1 0 1.5H7.923a.75.75 0 0 1 0-1.5"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystNewMassage3HeartBulk;
