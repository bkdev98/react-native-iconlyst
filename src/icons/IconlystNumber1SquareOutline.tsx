...
const IconlystNumber1SquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.952 7.66a.75.75 0 0 1 .548.723v8a.75.75 0 0 1-1.5 0V10.45a7 7 0 0 1-.876.583.75.75 0 0 1-.748-1.3c.452-.26.742-.476.983-.719.243-.246.464-.549.75-1.02a.75.75 0 0 1 .843-.333"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.5 16.383a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 0 1.5h-3a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystNumber1SquareOutline;
