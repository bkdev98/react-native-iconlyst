...
const IconlystGrassLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M3 19.739h18M11.866 4.26c.226 1.47.18 2.953-.038 4.353M8.202 19.739c-.55-2.567-2.136-6.19-4.966-8.622 0 0 1.595 6.063 1.287 8.622"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystGrassLight;
