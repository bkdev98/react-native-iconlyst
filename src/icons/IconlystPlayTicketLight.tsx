...
const IconlystPlayTicketLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M13.987 13.045a9.2 9.2 0 0 1-2.685 1.685c-.866.34-1.592-.085-1.699-.939a16.8 16.8 0 0 1 0-3.59c.116-.887.916-1.264 1.7-.935a9 9 0 0 1 2.683 1.685c.669.605.684 1.466 0 2.094"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
...
export default IconlystPlayTicketLight;
