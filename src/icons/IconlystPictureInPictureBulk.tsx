...
const IconlystPictureInPictureBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M16.21 11.969h-3.304c-1.013 0-1.123.853-1.123 1.22v2.14c0 .764.42 1.22 1.123 1.22h3.304c.704 0 1.124-.456 1.124-1.22v-2.14c0-.367-.109-1.22-1.124-1.22"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystPictureInPictureBulk;
