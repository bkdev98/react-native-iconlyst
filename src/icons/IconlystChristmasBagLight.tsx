...
const IconlystChristmasBagLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M12.354 7.038h2.128a1.5 1.5 0 0 1 1.496 1.387l.888 11.827a1.5 1.5 0 0 1-1.496 1.613h-3.016M10.225 12.265v5.357M12.546 13.605l-4.64 2.679M12.546 16.283l-4.64-2.678"
    />
  </Svg>
);
export default IconlystChristmasBagLight;
