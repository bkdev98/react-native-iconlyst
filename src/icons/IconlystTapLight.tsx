...
const IconlystTapLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M9.017 9.5C7.93 8.86 7.195 7.639 7.195 6.237c0-2.064 1.593-3.737 3.558-3.737s3.558 1.673 3.558 3.737c0 1.38-.711 2.584-1.77 3.232"
    />
  </Svg>
);
export default IconlystTapLight;
