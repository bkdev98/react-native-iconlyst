...
const IconlystMoneyPaper2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M5.715 15.549a.75.75 0 0 1 .75-.75h1.403a.75.75 0 0 1 0 1.5H6.465a.75.75 0 0 1-.75-.75M15.883 8.45a.75.75 0 0 1 .75-.75h1.403a.75.75 0 1 1 0 1.5h-1.403a.75.75 0 0 1-.75-.75M9.213 11.998a3.038 3.038 0 1 1 6.075 0 3.038 3.038 0 0 1-6.075 0m3.038-1.537a1.538 1.538 0 1 0-.001 3.075 1.538 1.538 0 0 0 .001-3.075"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystMoneyPaper2Outline;
