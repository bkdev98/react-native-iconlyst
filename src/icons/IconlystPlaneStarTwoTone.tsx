...
const IconlystPlaneStarTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M4.072 12.93c1.203-.5 3.576-1.52 4.798-2.028l-2.242-5.43c.607-.216 1.163-.467 1.745-.607.68-.162 1.265.146 1.765.585a178 178 0 0 1 3.415 3.045c.284.262.507.286.846.138.976-.43 1.954-.859 2.956-1.22 1.158-.419 2.807-.463 3.217.998.323 1.153-.67 2.134-1.647 2.547a600 600 0 0 1-9.757 4.036c-2.327.933-4.168.118-5.154-2.197-.089-.208-.427-1.03-.514-1.238"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M5.361 20.071h7.255"
    />
  </Svg>
);
export default IconlystPlaneStarTwoTone;
