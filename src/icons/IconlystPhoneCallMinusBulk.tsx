...
const IconlystPhoneCallMinusBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M16.493 7.39h4.79a.75.75 0 0 0 0-1.5h-4.79a.75.75 0 0 0 0 1.5"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystPhoneCallMinusBulk;
