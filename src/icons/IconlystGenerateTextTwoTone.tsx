...
const IconlystGenerateTextTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M11.5 20.43h.01M4.02 8.755c.148-.49.53-.873 1.02-1.021a1.53 1.53 0 0 1-1.02-1.022c-.149.49-.531.873-1.02 1.022.489.148.871.531 1.02 1.02"
    />
  </Svg>
);
export default IconlystGenerateTextTwoTone;
