...
const IconlystArtificialIntelligenceSignalLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M12 4.12 9.256 3l-4.17 2.729v3.003L3 9.804v4.393l2.085 1.07v3L9.256 21 12 19.875M12 18.125v1.755L14.744 21l4.17-2.729v-3.003L21 14.196V9.803l-2.085-1.07v-3L14.744 3 12 4.125v1.75M14.84 6.938V8.71"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystArtificialIntelligenceSignalLight;
