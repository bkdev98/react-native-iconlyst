...
const IconlystSportTicketTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M12.5 15.968a3.967 3.967 0 1 1 0-7.933 3.967 3.967 0 0 1 0 7.933"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M12.926 8.133a3.967 3.967 0 0 1-4.334 4.29M12.077 15.903a3.967 3.967 0 0 1 4.273-4.33"
    />
  </Svg>
);
export default IconlystSportTicketTwoTone;
