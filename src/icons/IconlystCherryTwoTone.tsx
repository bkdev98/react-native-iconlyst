...
const IconlystCherryTwoTone = ({
  ...
  >
    ...
    <G
      ...
      opacity={0.4}
    >
      <Path d="M16.176 13.045c-2.756-2.846-5.08-7.35-.875-9.831" />
      <Path d="M13.363 4.971c-2.116 2.148-6.405 2.692-5.49 7.524" />
    </G>
  </Svg>
);
export default IconlystCherryTwoTone;
