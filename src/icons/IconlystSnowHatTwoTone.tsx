...
const IconlystSnowHatTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M12 9.833v3.312m1.435-2.483-2.869 1.656m2.869 0-2.869-1.657M12 18.897v2.749M6.193 18.84v2.481M17.81 18.84v2.481"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystSnowHatTwoTone;
