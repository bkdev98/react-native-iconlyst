...
const IconlystAiBrainSecurityTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M8.254 9.827H5.328c-.802 0-1.453-.65-1.453-1.453V6.732c0-.802.65-1.453 1.453-1.453h2.926c.802 0 1.453.65 1.453 1.453v1.642c0 .802-.65 1.453-1.453 1.453"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M8.538 5.306V4.224a1.748 1.748 0 0 0-3.493-.006v1.088"
    />
    <G
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystAiBrainSecurityTwoTone;
