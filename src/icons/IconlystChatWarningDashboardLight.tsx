...
const IconlystChatWarningDashboardLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="m13.977 7.653 3.018 5.365a1.982 1.982 0 0 1-1.727 2.954H9.232a1.982 1.982 0 0 1-1.727-2.954l3.019-5.365a1.982 1.982 0 0 1 3.453 0"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
...
export default IconlystChatWarningDashboardLight;
