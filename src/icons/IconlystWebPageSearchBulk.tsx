...
const IconlystWebPageSearchBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.29 5.8a.75.75 0 0 0 0 1.5h.055a.75.75 0 0 0 0-1.5zm2.485 0a.75.75 0 0 0 0 1.5h.056a.75.75 0 0 0 0-1.5zm2.486 0a.75.75 0 0 0 0 1.5h.056a.75.75 0 0 0 0-1.5zM11.66 12a3.38 3.38 0 1 0 1.76 6.268l1.02 1.021a.75.75 0 0 0 1.061-1.06l-1.006-1.007A3.38 3.38 0 0 0 11.66 12m0 1.5a1.88 1.88 0 1 0 0 3.761 1.88 1.88 0 0 0 0-3.761"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystWebPageSearchBulk;
