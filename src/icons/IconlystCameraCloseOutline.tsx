...
const IconlystCameraCloseOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.934 10.7a.75.75 0 0 1 1.06 0l3.57 3.57a.75.75 0 1 1-1.06 1.06l-3.57-3.57a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.564 10.704a.75.75 0 0 1 0 1.06l-3.57 3.57a.75.75 0 1 1-1.06-1.061l3.57-3.569a.75.75 0 0 1 1.06 0"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystCameraCloseOutline;
