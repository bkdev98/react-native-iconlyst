...
const IconlystBusLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M4.716 17.907h-.31A2.157 2.157 0 0 1 2.25 15.75V8.142a2.157 2.157 0 0 1 2.157-2.156h12.98a1.88 1.88 0 0 1 1.538.808l2.995 4.293c.218.321.333.702.33 1.09l-.05 3.573a2.15 2.15 0 0 1-2.147 2.157h-.33M2.25 11.158h12.344M6.325 5.986v5.172M10.519 5.986v5.172"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M22.22 13.625h-6.626a1 1 0 0 1-1-1v-6.58"
    />
  </Svg>
);
export default IconlystBusLight;
