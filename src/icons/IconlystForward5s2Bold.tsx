...
const IconlystForward5s2Bold = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.22 13.94h-1.867a.75.75 0 0 0 0 1.5h1.866a2.103 2.103 0 0 0 2.102-2.1c0-1.157-.943-2.1-2.102-2.1h-1.116v-1.06h2.212a.75.75 0 0 0 0-1.5h-2.962a.75.75 0 0 0-.75.75v2.56c0 .415.336.75.75.75h1.866c.332 0 .602.27.602.6 0 .332-.27.6-.602.6"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystForward5s2Bold;
