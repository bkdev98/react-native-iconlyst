...
const IconlystWheelLockOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M18.303 13.808a2.5 2.5 0 0 1 2.528 2.465v1.09a.75.75 0 1 1-1.5 0v-1.075a.998.998 0 0 0-1.993-.005v1.08a.75.75 0 0 1-1.5 0v-1.1a2.5 2.5 0 0 1 2.465-2.455"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystWheelLockOutline;
