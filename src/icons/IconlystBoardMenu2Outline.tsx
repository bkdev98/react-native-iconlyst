...
const IconlystBoardMenu2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.887 9.395a.75.75 0 0 1 .75-.75h7.229a.75.75 0 0 1 0 1.5h-7.23a.75.75 0 0 1-.75-.75m0 5.208a.75.75 0 0 1 .75-.75h7.229a.75.75 0 1 1 0 1.5h-7.23a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystBoardMenu2Outline;
