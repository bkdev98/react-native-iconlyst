...
const IconlystAirpodCase1Light = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M19.684 11.92a1.64 1.64 0 0 0-1.639-1.639H6.64A1.64 1.64 0 0 0 5 11.921v5.015A4.064 4.064 0 0 0 9.063 21h6.558a4.063 4.063 0 0 0 4.063-4.064z"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystAirpodCase1Light;
