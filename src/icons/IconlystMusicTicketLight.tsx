...
const IconlystMusicTicketLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M13.355 13.668a1.937 1.937 0 1 1-3.874 0 1.937 1.937 0 0 1 3.874 0"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M13.355 13.67V7.856s.502 1.31 1.857 1.586"
    />
  </Svg>
);
export default IconlystMusicTicketLight;
