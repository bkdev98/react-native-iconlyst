...
const IconlystHeadlightsLeftStopOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M5.087 4.882a.75.75 0 0 0-.213 1.039 5.6 5.6 0 0 1 0 6.166 7.1 7.1 0 0 0 0 7.818.75.75 0 0 0 1.252-.826 5.6 5.6 0 0 1 0-6.166 7.1 7.1 0 0 0 0-7.818.75.75 0 0 0-1.039-.213"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystHeadlightsLeftStopOutline;
