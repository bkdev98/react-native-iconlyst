...
const IconlystUnderlineOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.314 17.027a.75.75 0 0 1 .75-.75h6.874a.75.75 0 0 1 0 1.5H9.064a.75.75 0 0 1-.75-.75M10.018 7.535a.75.75 0 0 1 .75.75v3.328a1.733 1.733 0 1 0 3.466 0V8.285a.75.75 0 0 1 1.5 0v3.328a3.233 3.233 0 1 1-6.466 0V8.285a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystUnderlineOutline;
