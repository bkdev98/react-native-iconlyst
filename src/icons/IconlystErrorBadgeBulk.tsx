...
const IconlystErrorBadgeBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.75 12.008a.75.75 0 0 1-1.5 0V8.992a.75.75 0 0 1 1.5 0zm-.752 3.774c-.414 0-.75-.312-.75-.726v-.047a.75.75 0 0 1 1.5 0c0 .414-.336.773-.75.773"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystErrorBadgeBulk;
