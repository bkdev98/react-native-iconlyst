...
const IconlystLinkedinTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M3.634 10.066c0-.263.213-.476.475-.476h2.585c.262 0 .475.213.475.476q.002 4.98-.001 9.959a.475.475 0 0 1-.476.475h-2.58a.475.475 0 0 1-.476-.475c-.004-3.32 0-6.64-.002-9.96"
      opacity={0.4}
    />
    <Circle
      cx={5.402}
...
export default IconlystLinkedinTwoTone;
