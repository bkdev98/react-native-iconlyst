...
const IconlystPinRefreshOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.25 8.383a2.08 2.08 0 0 0-1.383.523.75.75 0 0 1-.992-1.126 3.59 3.59 0 0 1 5.964 2.692.75.75 0 1 1-1.5 0 2.09 2.09 0 0 0-2.09-2.09M9.41 9.723a.75.75 0 0 1 .75.75 2.09 2.09 0 0 0 3.472 1.567.75.75 0 0 1 .992 1.125 3.59 3.59 0 0 1-5.964-2.692.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystPinRefreshOutline;
