...
const IconlystFarenheitDegreeWeatherLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M3.491 3.16v.042m.164-.032a.17.17 0 1 1-.34 0 .17.17 0 0 1 .34 0M9 3.893H6.375a.423.423 0 0 0-.423.423v5.402M9 7.052H5.952"
    />
  </Svg>
);
export default IconlystFarenheitDegreeWeatherLight;
