...
const IconlystPaperPlusBulkcurved = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M12.283 13.823h1.699a.75.75 0 1 0 0-1.5h-1.7v-1.7a.75.75 0 0 0-1.5 0v1.7h-1.7a.75.75 0 1 0 0 1.5h1.7v1.7a.75.75 0 0 0 1.5 0z"
    />
  </Svg>
);
export default IconlystPaperPlusBulkcurved;
