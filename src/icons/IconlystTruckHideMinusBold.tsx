...
const IconlystTruckHideMinusBold = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M5.588 6.997h2.886a.75.75 0 0 1 0 1.5H5.588a.75.75 0 0 1 0-1.5m1.443 5.35a4.61 4.61 0 0 0 4.608-4.6 4.614 4.614 0 0 0-4.608-4.61 4.613 4.613 0 0 0-4.607 4.61c0 2.537 2.066 4.6 4.607 4.6"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystTruckHideMinusBold;
