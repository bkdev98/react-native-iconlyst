...
const IconlystHeartRateOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.914 8.07a.75.75 0 0 1 .665.402l2.004 3.823.671-1.279a.75.75 0 0 1 .664-.401h1.78a.75.75 0 0 1 0 1.5h-1.326l-1.125 2.143a.75.75 0 0 1-1.328 0l-2.005-3.823-.67 1.278a.75.75 0 0 1-.665.402H7.801a.75.75 0 0 1 0-1.5h1.325l1.124-2.143a.75.75 0 0 1 .664-.402"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystHeartRateOutline;
