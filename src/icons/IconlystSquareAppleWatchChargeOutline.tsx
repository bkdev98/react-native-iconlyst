...
const IconlystSquareAppleWatchChargeOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.418 8.44a.75.75 0 0 1 .3 1.018l-.974 1.792h2.275a.75.75 0 0 1 .658 1.109L13.1 15.257a.75.75 0 0 1-1.317-.717l.974-1.79h-2.274a.75.75 0 0 1-.658-1.108l1.577-2.9a.75.75 0 0 1 1.017-.301"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystSquareAppleWatchChargeOutline;
