...
const IconlystCodepenTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m20.71 8.95-8.711 6.097-8.71-6.098"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m3.29 15.047 8.711-6.098 8.71 6.098m-8.71-11.758v5.663"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystCodepenTwoTone;
