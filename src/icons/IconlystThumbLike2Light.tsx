...
const IconlystThumbLike2Light = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M5.406 8.719h-.15c-.781 0-1.172 0-1.471.15-.275.137-.498.36-.635.634-.15.3-.15.69-.15 1.472v7.141c0 .782 0 1.172.15 1.472.137.274.36.497.635.635.299.15.69.15 1.47.15h.15c.782 0 1.172 0 1.472-.15.275-.138.497-.36.635-.635.15-.3.15-.69.15-1.472v-7.141c0-.782 0-1.172-.15-1.472a1.42 1.42 0 0 0-.635-.635c-.3-.15-.69-.15-1.471-.15"
    />
  </Svg>
);
export default IconlystThumbLike2Light;
