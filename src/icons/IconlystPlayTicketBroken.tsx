...
const IconlystPlayTicketBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M11.552 9.268c-.784-.33-1.583.048-1.7.935a16.8 16.8 0 0 0 0 3.59c.107.854.833 1.28 1.7.939a9.2 9.2 0 0 0 2.684-1.685c.684-.629.669-1.489 0-2.094"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystPlayTicketBroken;
