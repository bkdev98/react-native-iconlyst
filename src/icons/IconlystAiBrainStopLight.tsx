...
const IconlystAiBrainStopLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M13.696 7.55a3.19 3.19 0 1 1-4.556 4.466"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M13.696 7.55a3.19 3.19 0 0 0-4.556 4.466"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M13.696 7.55 9.14 12.018"
    />
  </Svg>
);
export default IconlystAiBrainStopLight;
