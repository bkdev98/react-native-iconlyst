...
const IconlystSleighLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M9.003 12.19c-.24-1.773 1.185-4.925 6.168-5.476 0 0 .051-2.345 1.284-3.283.96 2.01 2.621.49 3.861 1.748 0 0-1.443 1.14-1.724 2.35M15.248 6.688l1.8 1.75"
    />
  </Svg>
);
export default IconlystSleighLight;
