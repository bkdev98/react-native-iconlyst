...
const IconlystNewNotificationOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M18.895 3.87a1.606 1.606 0 1 0 0 3.212 1.606 1.606 0 0 0 0-3.212m-3.106 1.606a3.106 3.106 0 1 1 6.212 0 3.106 3.106 0 0 1-6.212 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystNewNotificationOutline;
