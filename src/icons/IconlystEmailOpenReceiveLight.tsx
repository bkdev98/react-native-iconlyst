...
const IconlystEmailOpenReceiveLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M19.738 7.358a4.311 4.311 0 1 1-6.098 6.096 4.311 4.311 0 0 1 6.098-6.096"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m18.21 11.12-2.195-.04-.038-2.194M16.016 11.08l3.554-3.555"
    />
  </Svg>
);
export default IconlystEmailOpenReceiveLight;
