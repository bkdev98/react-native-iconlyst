...
const IconlystKeyboard1Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.05 16.14a.75.75 0 0 1 .75-.75h4.898a.75.75 0 1 1 0 1.5H9.8a.75.75 0 0 1-.75-.75M11.383 11.982a.863.863 0 1 1 1.726 0 .863.863 0 0 1-1.726 0M11.383 8.593a.863.863 0 1 1 1.726 0 .863.863 0 0 1-1.726 0M6.936 11.982a.863.863 0 1 1 1.725 0 .863.863 0 0 1-1.725 0M6.936 8.593a.863.863 0 1 1 1.725 0 .863.863 0 0 1-1.725 0M15.838 11.982a.863.863 0 1 1 1.726 0 .863.863 0 0 1-1.726 0M15.838 8.593a.863.863 0 1 1 1.726 0 .863.863 0 0 1-1.726 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystKeyboard1Outline;
