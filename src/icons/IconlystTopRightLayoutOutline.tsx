...
const IconlystTopRightLayoutOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.56 7.656a.75.75 0 0 1 .75-.75h7.298a.75.75 0 1 1 0 1.5H10.31a.75.75 0 0 1-.75-.75m3.93 4.379a.75.75 0 0 1 .75-.75h3.368a.75.75 0 1 1 0 1.5H14.24a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystTopRightLayoutOutline;
