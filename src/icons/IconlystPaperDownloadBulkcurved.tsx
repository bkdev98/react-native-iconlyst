...
const IconlystPaperDownloadBulkcurved = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      d="m11.425 17.046 2.345-2.353a.75.75 0 0 0-1.062-1.059l-1.065 1.069v-4.225a.75.75 0 0 0-1.5 0v4.224L9.08 13.634a.75.75 0 1 0-1.063 1.059l2.344 2.353a.75.75 0 0 0 1.064 0"
    />
  </Svg>
);
export default IconlystPaperDownloadBulkcurved;
