...
const IconlystWaterEcologyTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M15.965 3s2.022 1.595 1.992 3.553v.002c.02 1.114-1.006 2.035-1.992 2.022-.987.013-2.014-.908-1.993-2.022v-.002C13.942 4.595 15.965 3 15.965 3M7.53 5.168S9.331 6.59 9.304 8.335v.002c.019.994-.896 1.815-1.776 1.804-.88.011-1.795-.81-1.776-1.804v-.002C5.726 6.59 7.529 5.168 7.529 5.168"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
...
export default IconlystWaterEcologyTwoTone;
