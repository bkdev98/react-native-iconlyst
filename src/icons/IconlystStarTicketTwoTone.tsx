...
const IconlystStarTicketTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M8.288 16.809v.01M8.288 13.602v.01M8.288 10.39v.01M8.288 7.18v.01"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
