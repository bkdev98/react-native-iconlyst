...
const IconlystDiskMusicSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.219 12a6.053 6.053 0 0 1 8.941-5.32.75.75 0 1 1-.716 1.317 4.553 4.553 0 1 0 1.595 6.56.75.75 0 1 1 1.24.844A6.053 6.053 0 0 1 6.22 12M18.041 16.857a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0v-.01a.75.75 0 0 1 .75-.75M6.459 16.877a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0v-.01a.75.75 0 0 1 .75-.75M6.459 5.594a.75.75 0 0 1 .75.75v.01a.75.75 0 1 1-1.5 0v-.01a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.705 11.25a.75.75 0 0 1 .75.75c0 .992.804 1.795 1.795 1.795a.75.75 0 0 1 0 1.5A3.295 3.295 0 0 1 8.955 12a.75.75 0 0 1 .75-.75M17.916 2.475a.75.75 0 0 1 .75.75v7.27a.75.75 0 0 1-.396.662l-3.113 1.665a.75.75 0 0 1-.708-1.323l2.717-1.453V3.225a.75.75 0 0 1 .75-.75M12.25 10.924a.75.75 0 0 1 .75.75v.01a.75.75 0 0 1-1.5 0v-.01a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
