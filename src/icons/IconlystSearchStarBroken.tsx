...
const IconlystSearchStarBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M10.541 3.573a8.18 8.18 0 0 0-2.69 15.409M19.668 12.756a8.18 8.18 0 0 1-8.11 7.112M17.125 17.68 20.453 21"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystSearchStarBroken;
