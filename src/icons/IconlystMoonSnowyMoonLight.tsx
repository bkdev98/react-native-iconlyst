...
const IconlystMoonSnowyMoonLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M5.367 19.277 3.114 20.53m2.253-1.252 2.252-1.252m-2.252 1.252 2.252 1.252m-2.252-1.252-2.253-1.252m2.253 1.252v2.503m0-2.503v-2.503M13.632 18.886l.01.01M10.424 21.78l.009.01M7.129 14.194l.01.01"
    />
  </Svg>
);
export default IconlystMoonSnowyMoonLight;
