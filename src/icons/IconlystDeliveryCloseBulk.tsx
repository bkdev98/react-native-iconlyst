...
const IconlystDeliveryCloseBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="m10.765 9.617 1.864-.615a.75.75 0 0 1 .466 0l1.848.6-.013-6.803a.3.3 0 0 0-.3-.299l-3.574.009a.3.3 0 0 0-.3.3zM21.396 21.329a.75.75 0 0 1-.53-.22l-1.412-1.41-1.411 1.41a.751.751 0 0 1-1.061-1.062l1.41-1.408-1.41-1.41a.75.75 0 0 1 1.06-1.061l1.412 1.41 1.412-1.41a.751.751 0 0 1 1.06 1.062l-1.41 1.409 1.41 1.409a.751.751 0 0 1-.53 1.28"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDeliveryCloseBulk;
