...
const IconlystPathEditBroken = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M7.703 6.174h4.657m-4.657 13.52h3.155m-5.39-7.292v5.045M18.937 8.44v2.196M17.264 20.925a2.34 2.34 0 0 1-1.358.75l-.977.163a1.094 1.094 0 0 1-1.268-1.197l.109-1.007a2.34 2.34 0 0 1 .582-1.308l3.61-4a1.34 1.34 0 0 1 1.894-.072l.898.83a1.34 1.34 0 0 1 .073 1.895l-1.403 1.554"
    />
  </Svg>
);
export default IconlystPathEditBroken;
