...
const IconlystIncreaseBrightnessBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.51 8.887a.75.75 0 0 1 .75.75v1.612h1.614a.75.75 0 0 1 0 1.5h-1.615v1.615a.75.75 0 1 1-1.5 0v-1.615h-1.613a.75.75 0 1 1 0-1.5h1.613V9.638a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
