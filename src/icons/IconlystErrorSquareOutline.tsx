...
const IconlystErrorSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.256 7.357a.75.75 0 0 1 .75.75V12a.75.75 0 0 1-1.5 0V8.107a.75.75 0 0 1 .75-.75m0 7.586a.75.75 0 0 1 .75.75v.048a.75.75 0 0 1-1.5 0v-.048a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystErrorSquareOutline;
