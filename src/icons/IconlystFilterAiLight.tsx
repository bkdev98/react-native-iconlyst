...
const IconlystFilterAiLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m10.054 8.414-.1-.274A3.76 3.76 0 0 0 7.73 5.915l-.273-.1.273-.102a3.76 3.76 0 0 0 2.222-2.225l.101-.273.101.273a3.76 3.76 0 0 0 2.222 2.225l.273.101-.273.101a3.76 3.76 0 0 0-2.222 2.225zM15.365 9.656a1.77 1.77 0 0 0-1.177-1.179A1.77 1.77 0 0 0 15.365 7.3a1.77 1.77 0 0 0 1.176 1.178 1.77 1.77 0 0 0-1.176 1.179"
    />
  </Svg>
);
export default IconlystFilterAiLight;
