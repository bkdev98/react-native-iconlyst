...
const IconlystBoardMenuOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.564 9.395a.75.75 0 0 1 .75-.75h.305a.75.75 0 1 1 0 1.5h-.305a.75.75 0 0 1-.75-.75m3.561 0a.75.75 0 0 1 .75-.75h4.31a.75.75 0 0 1 0 1.5h-4.31a.75.75 0 0 1-.75-.75m-3.56 5.208a.75.75 0 0 1 .75-.75h.304a.75.75 0 1 1 0 1.5h-.305a.75.75 0 0 1-.75-.75m3.56 0a.75.75 0 0 1 .75-.75h4.31a.75.75 0 1 1 0 1.5h-4.31a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystBoardMenuOutline;
