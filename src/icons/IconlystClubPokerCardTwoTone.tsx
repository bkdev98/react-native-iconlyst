...
const IconlystClubPokerCardTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M16.5 6v.01M8.5 18v.01M12.473 13.47c.527.7 1.24.794 1.7.805a1.71 1.71 0 0 0 1.604-.943c.43-.87.01-1.97-.9-2.325a1.7 1.7 0 0 0-1.134-.038 1.71 1.71 0 0 0 .23-1.881 1.704 1.704 0 0 0-1.903-.87 1.7 1.7 0 0 0-1.22 1.165 1.72 1.72 0 0 0 .343 1.584c-.391-.1-.79-.103-1.169.06a1.71 1.71 0 0 0-.919 2.146 1.7 1.7 0 0 0 1.566 1.095c.487.001 1.329-.098 1.802-.798m0 0c0 1.965.004 2.408.004 2.408"
    />
  </Svg>
);
export default IconlystClubPokerCardTwoTone;
