...
const IconlystArrowsHorizontalMaximizeSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.475 9.025a.75.75 0 0 1 0 1.06L8.31 11.25h2.467a.75.75 0 0 1 0 1.5H8.31l1.164 1.164a.75.75 0 0 1-1.06 1.06L5.97 12.53a.75.75 0 0 1 0-1.06l2.444-2.445a.75.75 0 0 1 1.06 0m5.05 0a.75.75 0 0 1 1.06 0l2.445 2.445a.75.75 0 0 1 0 1.06l-2.444 2.445a.75.75 0 0 1-1.06-1.06l1.163-1.165h-2.467a.75.75 0 0 1 0-1.5h2.467l-1.164-1.164a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystArrowsHorizontalMaximizeSquareOutline;
