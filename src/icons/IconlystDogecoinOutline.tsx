...
const IconlystDogecoinOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.236 8.49a.75.75 0 0 1 .75-.75h2.697a4.26 4.26 0 0 1 0 8.52H9.986a.75.75 0 0 1-.75-.75zm1.5.75v5.52h1.947a2.76 2.76 0 0 0 0-5.52z"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.975 12a.75.75 0 0 1 .75-.75h3.737a.75.75 0 0 1 0 1.5H8.725a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDogecoinOutline;
