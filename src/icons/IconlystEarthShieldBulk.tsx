...
const IconlystEarthShieldBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M17.423 14c-.467 0-2.796.773-3.167 1.15-.309.316-.306.492-.289 1.334.008.357.018.87.018 1.625 0 2.789 3.16 3.778 3.293 3.819a.5.5 0 0 0 .29 0c.134-.041 3.295-1.03 3.295-3.819 0-.751.01-1.263.017-1.62.018-.859.021-1.038-.29-1.339-.367-.376-2.697-1.15-3.167-1.15"
      clipRule="evenodd"
    />
  </Svg>
);
