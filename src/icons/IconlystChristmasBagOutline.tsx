...
const IconlystChristmasBagOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M11.604 7.038a.75.75 0 0 1 .75-.75h2.128a2.25 2.25 0 0 1 2.244 2.081l.888 11.827a2.25 2.25 0 0 1-2.244 2.419h-3.016a.75.75 0 0 1 0-1.5h3.016a.75.75 0 0 0 .748-.806L15.23 8.48a.75.75 0 0 0-.748-.693h-2.128a.75.75 0 0 1-.75-.75M10.225 11.515a.75.75 0 0 1 .75.75v5.357a.75.75 0 0 1-1.5 0v-5.357a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M13.195 13.23a.75.75 0 0 1-.274 1.025l-4.64 2.678a.75.75 0 1 1-.75-1.299l4.64-2.678a.75.75 0 0 1 1.024.274"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M13.195 16.659a.75.75 0 0 0-.274-1.025l-4.64-2.678a.75.75 0 0 0-.75 1.299l4.64 2.678a.75.75 0 0 0 1.024-.274"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystChristmasBagOutline;
