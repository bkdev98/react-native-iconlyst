...
const IconlystShieldLock2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.91 11.25a.925.925 0 1 0-1.31 1.31h.001a.925.925 0 1 0 1.31-1.31m-2.37-1.06a2.425 2.425 0 1 1 2.404 4.042v1.535a.75.75 0 0 1-1.5 0v-1.575a2.4 2.4 0 0 1-.904-.572m0 0a2.425 2.425 0 0 1 0-3.43"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystShieldLock2Outline;
