...
const IconlystStarDropLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M6.268 4.96v3.258M12 3.916v1.37M17.732 4.96v3.258"
    />
  </Svg>
);
export default IconlystStarDropLight;
