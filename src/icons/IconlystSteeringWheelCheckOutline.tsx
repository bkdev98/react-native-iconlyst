...
const IconlystSteeringWheelCheckOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.095 16.82c.917 1.014 1.397 2.587 1.397 4.823a.75.75 0 0 0 1.5 0c0-2.413-.513-4.422-1.785-5.83-1.286-1.42-3.217-2.086-5.734-2.086a.75.75 0 0 0 0 1.5c2.265 0 3.718.594 4.622 1.593M12.25 13.22a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5m-2.25.75a2.25 2.25 0 1 1 4.5 0 2.25 2.25 0 0 1-4.5 0M22.777 16.086a.75.75 0 0 1 .001 1.06l-4.345 4.358a.75.75 0 0 1-1.061 0l-2.312-2.31a.75.75 0 0 1 1.061-1.062l1.78 1.781 3.815-3.826a.75.75 0 0 1 1.06-.001"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystSteeringWheelCheckOutline;
