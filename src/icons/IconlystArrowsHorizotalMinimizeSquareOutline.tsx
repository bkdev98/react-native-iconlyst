...
const IconlystArrowsHorizotalMinimizeSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M16.197 9.025a.75.75 0 0 1 0 1.061l-1.164 1.164H17.5a.75.75 0 1 1 0 1.5h-2.467l1.164 1.164a.75.75 0 0 1-1.06 1.06l-2.445-2.444a.75.75 0 0 1 0-1.06l2.444-2.445a.75.75 0 0 1 1.06 0M7.803 9.025a.75.75 0 0 1 1.06 0l2.445 2.445a.75.75 0 0 1 0 1.06l-2.444 2.445a.75.75 0 1 1-1.06-1.06l1.163-1.165H6.5a.75.75 0 1 1 0-1.5h2.467l-1.164-1.164a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystArrowsHorizotalMinimizeSquareOutline;
