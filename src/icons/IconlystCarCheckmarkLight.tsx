...
const IconlystCarCheckmarkLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m18.635 16.572-1.596 1.6-.959-.962M14.32 11.048h1.573M6.551 11.048h1.573M3.356 7.385c5.215.74 10.509.74 15.724 0"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystCarCheckmarkLight;
