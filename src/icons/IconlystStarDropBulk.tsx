...
const IconlystStarDropBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.768 9.093a.75.75 0 0 0 .75-.75v-3.26a.75.75 0 0 0-1.5 0v3.26c0 .414.336.75.75.75M12.5 6.163a.75.75 0 0 0 .75-.75v-1.37a.75.75 0 0 0-1.5 0v1.37c0 .414.336.75.75.75M18.233 9.093a.75.75 0 0 0 .75-.75v-3.26a.75.75 0 0 0-1.5 0v3.26c0 .414.336.75.75.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystStarDropBulk;
