...
const IconlystScanAiTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M21 8.47V6.895a3.89 3.89 0 0 0-3.893-3.892H15.85M3 8.47V6.895a3.89 3.89 0 0 1 3.893-3.892h1.289M3 15.53v1.576a3.89 3.89 0 0 0 3.893 3.892H8.15M21 15.53v1.576a3.89 3.89 0 0 1-3.893 3.892h-1.289"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
...
export default IconlystScanAiTwoTone;
