...
const IconlystScanImageBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.167 14.833c.227.406.64.648 1.104.648h9.458a1.25 1.25 0 0 0 1.103-.647 1.25 1.25 0 0 0-.025-1.276l-1.716-2.805a1.27 1.27 0 0 0-.983-.601 1.24 1.24 0 0 0-1.058.44l-.647.759c-.072.085-.156.105-.213.092a.26.26 0 0 1-.204-.11l-1.801-2.531a1.26 1.26 0 0 0-2.106.071l-2.884 4.68a1.25 1.25 0 0 0-.028 1.28"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystScanImageBulk;
