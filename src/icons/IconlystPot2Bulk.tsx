...
const IconlystPot2Bulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M12.994 3.8a.9.9 0 1 0-1.8 0v1.11c-2.77.277-5.11 1.97-6.215 4.382a.5.5 0 0 0 .454.708h13.135a.5.5 0 0 0 .454-.708c-1.08-2.357-3.34-4.028-6.028-4.362z"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystPot2Bulk;
