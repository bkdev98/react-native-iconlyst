...
const IconlystNightBrightnessBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M12.225 7.715c-.86 0-1.66.253-2.332.69a.5.5 0 0 0 0 .838A3.28 3.28 0 0 1 11.392 12a3.28 3.28 0 0 1-1.5 2.758.5.5 0 0 0 0 .839 4.286 4.286 0 1 0 2.332-7.883"
    />
  </Svg>
);
