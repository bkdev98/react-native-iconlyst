...
const IconlystAiBrainBitcoinLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M11.92 11.102H9.74v3.122h2.249c.912 0 1.642-.783 1.553-1.715-.078-.812-.805-1.407-1.62-1.407"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M11.92 7.98H9.74v3.123h2.249c.912 0 1.642-.783 1.553-1.715-.078-.812-.805-1.408-1.62-1.408M11.364 15.145v-.92M11.364 7.977v-.92"
    />
  </Svg>
);
export default IconlystAiBrainBitcoinLight;
