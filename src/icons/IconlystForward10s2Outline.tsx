...
const IconlystForward10s2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.26 8.691a.75.75 0 0 1 .75.75v5.115a.75.75 0 0 1-1.5 0V9.441a.75.75 0 0 1 .75-.75M12.429 10.094a.82.82 0 0 0-.822.822v2.166a.821.821 0 0 0 1.643 0v-2.166a.82.82 0 0 0-.821-.822m-2.322.822a2.322 2.322 0 1 1 4.643 0v2.166a2.321 2.321 0 1 1-4.643 0zM21.614 9.935a.75.75 0 0 1 0 1.06l-1.652 1.652a.75.75 0 0 1-1.06 0l-1.643-1.642a.75.75 0 1 1 1.06-1.06l1.113 1.111 1.121-1.121a.75.75 0 0 1 1.06 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystForward10s2Outline;
