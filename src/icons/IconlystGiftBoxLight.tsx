...
const IconlystGiftBoxLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M12.003 13.179c0 1.787 1.24 3.234 2.77 3.234.66 0 1.193-.534 1.193-1.193 0-1.438-1.775-2.605-3.964-2.605s-3.966 1.167-3.966 2.605c0 .66.535 1.193 1.194 1.193 1.529 0 2.77-1.447 2.77-3.234M21 12.615H3M12 21.615v-18"
    />
  </Svg>
);
export default IconlystGiftBoxLight;
