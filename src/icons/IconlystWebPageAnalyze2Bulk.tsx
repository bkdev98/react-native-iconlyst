...
const IconlystWebPageAnalyze2Bulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.108 5.8a.75.75 0 0 0 0 1.5h.055a.75.75 0 1 0 0-1.5zm2.485 0a.75.75 0 0 0 0 1.5h.056a.75.75 0 1 0 0-1.5zm2.487 0a.75.75 0 0 0 0 1.5h.055a.75.75 0 1 0 0-1.5zM17 14.145a.75.75 0 0 0-1.186-.919l-1.789 2.31-2.03-1.595a.75.75 0 0 0-1.058.133l-2.3 2.99a.75.75 0 0 0 1.188.914l1.839-2.39 2.028 1.594a.75.75 0 0 0 1.057-.13z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystWebPageAnalyze2Bulk;
