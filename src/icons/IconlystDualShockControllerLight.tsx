...
const IconlystDualShockControllerLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M9.438 11.164a1.435 1.435 0 1 0-2.87 0 1.435 1.435 0 0 0 2.87 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDualShockControllerLight;
