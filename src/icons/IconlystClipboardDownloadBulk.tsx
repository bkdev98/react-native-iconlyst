...
const IconlystClipboardDownloadBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.81 5.48h4.38c.68 0 1.24-.54 1.26-1.22.01-.02.01-.04.01-.06v-.54c0-.7-.57-1.27-1.27-1.27H9.81c-.7 0-1.28.57-1.28 1.27v.54c0 .02 0 .03.01.05.02.69.59 1.23 1.27 1.23M14.64 15.059l-2.11 2.12c-.14.14-.32.22-.53.22-.23 0-.43-.1-.56-.25l-2.08-2.09a.754.754 0 0 1 0-1.06c.29-.29.77-.29 1.06 0l.83.83v-3.61c0-.42.33-.75.75-.75.41 0 .75.33.75.75v3.62l.83-.84c.29-.29.77-.29 1.06 0s.29.77 0 1.06"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystClipboardDownloadBulk;
