...
const IconlystTicketAiTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M8.75 10.353H12M17.423 13.303l.101.273a3.76 3.76 0 0 0 2.222 2.225l.273.101-.273.102a3.76 3.76 0 0 0-2.222 2.225l-.1.273-.102-.273a3.76 3.76 0 0 0-2.221-2.225l-.274-.102.274-.1a3.76 3.76 0 0 0 2.221-2.226zM10.824 16.145A1.77 1.77 0 0 0 12 17.323a1.77 1.77 0 0 0-1.176 1.179 1.77 1.77 0 0 0-1.177-1.178 1.77 1.77 0 0 0 1.177-1.179"
    />
  </Svg>
);
export default IconlystTicketAiTwoTone;
