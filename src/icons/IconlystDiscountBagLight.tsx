...
const IconlystDiscountBagLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M12.354 7.038h2.128a1.5 1.5 0 0 1 1.496 1.387l.888 11.827a1.5 1.5 0 0 1-1.496 1.613h-3.016M12.189 13.05l-3.923 3.923M12.183 16.959l.006.007M8.26 13.05h.006"
    />
  </Svg>
);
export default IconlystDiscountBagLight;
