...
const IconlystMap3DBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M14.9 9.007c0-.38.28-.7.65-.75 3.35-.46 4.86-1.53 4.86-2.14 0-.6-1.55-1.7-4.86-2.16-1.95-.28-4.16-.27-6.09 0-3.32.46-4.87 1.56-4.87 2.16 0 .61 1.51 1.68 4.86 2.14.37.05.65.37.65.75v5.35c1.57-.16 3.23-.16 4.8 0z"
    />
  </Svg>
);
export default IconlystMap3DBulk;
