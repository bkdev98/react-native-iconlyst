...
const IconlystFolderFileDownOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.522 13.633a.75.75 0 0 1 1.06.002l1.667 1.675 1.669-1.675a.75.75 0 0 1 1.062 1.058l-2.2 2.209a.75.75 0 0 1-1.062 0l-2.199-2.209a.75.75 0 0 1 .003-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.25 9.459a.75.75 0 0 1 .75.75v6.163a.75.75 0 0 1-1.5 0V10.21a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileDownOutline;
