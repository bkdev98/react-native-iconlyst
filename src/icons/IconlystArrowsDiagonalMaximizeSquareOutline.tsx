...
const IconlystArrowsDiagonalMaximizeSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.5 6.75h4.154a.75.75 0 1 1 0 1.5H9.31l2.094 2.095a.75.75 0 1 1-1.06 1.06L8.25 9.311v2.343a.75.75 0 1 1-1.5 0V7.5a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M16.5 11.596a.75.75 0 0 1 .75.75V16.5a.75.75 0 0 1-.75.75h-4.154a.75.75 0 1 1 0-1.5h2.343l-2.094-2.095a.75.75 0 0 1 1.06-1.06l2.095 2.094v-2.343a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystArrowsDiagonalMaximizeSquareOutline;
