...
const IconlystClipboardTextBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.81 5.48h4.38c.68 0 1.24-.54 1.26-1.22.01-.02.01-.04.01-.06v-.54c0-.7-.57-1.27-1.27-1.27H9.81c-.7 0-1.28.57-1.28 1.27v.54c0 .02 0 .03.01.05.02.69.59 1.23 1.27 1.23M15.02 16.158H8.99c-.42 0-.75-.33-.75-.75 0-.41.33-.75.75-.75h6.03c.42 0 .75.34.75.75 0 .42-.33.75-.75.75m-6.03-5.51H12c.42 0 .75.34.75.76 0 .41-.33.74-.75.74H8.99a.74.74 0 0 1-.75-.74c0-.42.33-.76.75-.76"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystClipboardTextBulk;
