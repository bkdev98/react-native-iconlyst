...
const IconlystPlus1Bulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M12.751 8.695a.75.75 0 0 0-1.5 0v2.548h-2.55a.75.75 0 0 0 0 1.5h2.55v2.545a.75.75 0 1 0 1.5 0v-2.545H15.3a.75.75 0 1 0 0-1.5H12.75z"
    />
  </Svg>
);
export default IconlystPlus1Bulk;
