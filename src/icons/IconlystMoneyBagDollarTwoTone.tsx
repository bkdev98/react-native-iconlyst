...
const IconlystMoneyBagDollarTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M13.87 12.332h-1.978a1.065 1.065 0 1 0 0 2.132h1.218a1.065 1.065 0 1 1 0 2.13h-1.98M12.5 16.596v.895m0-6.057v.902"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M9.346 7.977q3.154.724 6.31 0"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystMoneyBagDollarTwoTone;
