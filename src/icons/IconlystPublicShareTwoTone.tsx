...
const IconlystPublicShareTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M11.733 16.746c.675-.1 1.363.001 2.045-.015 1.582-.038 2.822-1.375 4.026-2.282a1.54 1.54 0 0 1 2.021.144 1.556 1.556 0 0 1 0 2.195c-1.3 1.307-2.45 2.518-4.212 3.203-2.447.952-4.717.49-7.194 0-.959-.19-2.77-.2-3.74-.2"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystPublicShareTwoTone;
