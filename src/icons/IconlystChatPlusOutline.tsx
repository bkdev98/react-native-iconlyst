...
const IconlystChatPlusOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.551 8.086a.75.75 0 0 1 .75.75v1.573h1.563a.75.75 0 0 1 0 1.5H13.3v1.577a.75.75 0 0 1-1.5 0v-1.577h-1.563a.75.75 0 1 1 0-1.5h1.563V8.836a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystChatPlusOutline;
