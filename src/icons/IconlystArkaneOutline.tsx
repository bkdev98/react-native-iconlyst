...
const IconlystArkaneOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.434 7.734A2.01 2.01 0 0 1 12.25 6.55c.776 0 1.502.473 1.816 1.183l3.809 8.575a.75.75 0 0 1-1.371.609l-3.81-8.576V8.34a.51.51 0 0 0-.444-.29.51.51 0 0 0-.444.29v.002l-3.81 8.576a.75.75 0 1 1-1.37-.61z"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.676 12.496a.75.75 0 0 1 .75-.75h1.646a.75.75 0 0 1 0 1.5h-1.646a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystArkaneOutline;
