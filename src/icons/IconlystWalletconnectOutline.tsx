...
const IconlystWalletconnectOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.22 12.22a.75.75 0 0 1 1.06 0L10 13.94l1.72-1.72a.75.75 0 0 1 1.06 0l1.72 1.72 1.72-1.72a.75.75 0 1 1 1.06 1.06l-2.25 2.25a.75.75 0 0 1-1.06 0l-1.72-1.72-1.72 1.72a.75.75 0 0 1-1.06 0l-2.25-2.25a.75.75 0 0 1 0-1.06M12.254 9.742c-.985 0-1.96.405-2.656 1.103a.75.75 0 1 1-1.063-1.059 5.3 5.3 0 0 1 3.719-1.544c1.384 0 2.742.564 3.719 1.544a.75.75 0 0 1-1.063 1.06 3.8 3.8 0 0 0-2.656-1.104"
      clipRule="evenodd"
    />
  </Svg>
);
