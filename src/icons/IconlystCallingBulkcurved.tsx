...
const IconlystCallingBulkcurved = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M17.541 10.292a.75.75 0 0 0 1.473-.287 5.16 5.16 0 0 0-4.094-4.093.75.75 0 0 0-.285 1.473 3.66 3.66 0 0 1 2.906 2.907"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystCallingBulkcurved;
