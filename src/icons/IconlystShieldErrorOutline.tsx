...
const IconlystShieldErrorOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.251 15.217a.75.75 0 0 1 .75.75v.099a.75.75 0 0 1-1.5 0v-.1a.75.75 0 0 1 .75-.75M12.247 8.396a.75.75 0 0 1 .75.75v3.794a.75.75 0 0 1-1.5 0V9.146a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystShieldErrorOutline;
