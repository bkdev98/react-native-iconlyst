...
const IconlystMoneyPaperRefreshOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M5.713 8.514a.75.75 0 0 1 .75-.75h1.403a.75.75 0 0 1 0 1.5H6.463a.75.75 0 0 1-.75-.75M16.035 15.615a.75.75 0 0 1 .75.75 1.858 1.858 0 0 0 3.086 1.394.75.75 0 0 1 .993 1.124 3.358 3.358 0 0 1-5.58-2.518.75.75 0 0 1 .751-.75M18.643 14.508c-.472 0-.901.175-1.229.464a.75.75 0 0 1-.993-1.124 3.358 3.358 0 0 1 5.58 2.518.75.75 0 0 1-1.5 0 1.86 1.86 0 0 0-1.858-1.858M12.248 10.527a1.537 1.537 0 1 0 0 3.075 1.537 1.537 0 0 0 0-3.075m-3.037 1.538a3.037 3.037 0 1 1 6.075 0 3.037 3.037 0 0 1-6.075 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystMoneyPaperRefreshOutline;
