...
const IconlystCarEnergyTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="m17.55 13.353-2.91 4.01a.432.432 0 0 0 .35.686h2.38v2.518c0 .418.537.593.784.253l2.91-4.009a.433.433 0 0 0-.349-.687h-2.382v-2.517a.433.433 0 0 0-.783-.255"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M14.32 11.049h1.573M6.551 11.049h1.573M3.356 7.385c5.215.74 10.509.74 15.724 0"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
...
export default IconlystCarEnergyTwoTone;
