...
const IconlystWebPageUploadBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M13.568 21.5v-5.395l1.316 1.316a.75.75 0 1 0 1.06-1.06l-2.596-2.597a.75.75 0 0 0-1.06 0L9.69 16.36a.75.75 0 0 0 1.061 1.06l1.316-1.316V21.5z"
    />
  </Svg>
);
export default IconlystWebPageUploadBulk;
