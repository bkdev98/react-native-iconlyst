...
const IconlystFolderFileRightOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.592 10.563a.75.75 0 0 1 1.06-.003l2.209 2.2a.75.75 0 0 1 0 1.063l-2.209 2.198a.75.75 0 1 1-1.058-1.062l1.675-1.668-1.675-1.668a.75.75 0 0 1-.002-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.418 13.291a.75.75 0 0 1 .75-.75h6.164a.75.75 0 0 1 0 1.5H9.168a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileRightOutline;
