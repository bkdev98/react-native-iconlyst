...
const IconlystLinuxSquareTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M10.65 11.688v1.69M13.35 11.688v1.69M16.95 15.288v-3.15A4.95 4.95 0 0 0 12 7.187v0a4.95 4.95 0 0 0-4.95 4.95v3.15"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystLinuxSquareTwoTone;
