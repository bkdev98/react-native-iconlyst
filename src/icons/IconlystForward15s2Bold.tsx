...
const IconlystForward15s2Bold = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M13.32 13.81h-1.814a.75.75 0 1 0 0 1.5h1.814a2.07 2.07 0 0 0 2.064-2.07c0-1.136-.925-2.06-2.064-2.06h-1.064v-.99h2.129a.75.75 0 0 0 0-1.5h-2.88a.75.75 0 0 0-.75.75v2.49c0 .414.336.75.75.75h1.815c.312 0 .564.251.564.56 0 .314-.252.57-.564.57M8.148 9.44v5.12a.75.75 0 0 0 1.5 0V9.44a.75.75 0 0 0-1.5 0"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystForward15s2Bold;
