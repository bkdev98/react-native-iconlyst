...
const IconlystAirpodsFullBatteryBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M17.962 5.677a.75.75 0 0 1 1.499 0v1.366a.75.75 0 1 1-1.5 0zM6.612 8.171a.75.75 0 0 0-1.499 0v1.365a.75.75 0 1 0 1.5 0z"
    />
  </Svg>
);
export default IconlystAirpodsFullBatteryBulk;
