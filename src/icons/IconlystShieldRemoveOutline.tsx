...
const IconlystShieldRemoveOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.926 10.413a.75.75 0 0 1 1.06 0l1.264 1.264 1.264-1.264a.75.75 0 1 1 1.06 1.06l-1.263 1.264L14.574 14a.75.75 0 1 1-1.06 1.061l-1.264-1.263-1.264 1.263a.75.75 0 1 1-1.06-1.06l1.263-1.264-1.263-1.263a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystShieldRemoveOutline;
