...
const IconlystPaperBulkcurved = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M8.689 16.292h5.399a.75.75 0 1 0 0-1.5H8.689a.75.75 0 0 0 0 1.5M12.043 10.78H8.687a.75.75 0 0 0 0 1.5h3.356a.75.75 0 1 0 0-1.5"
    />
  </Svg>
);
export default IconlystPaperBulkcurved;
