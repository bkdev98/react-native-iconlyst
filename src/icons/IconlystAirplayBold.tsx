...
const IconlystAirplayBold = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M13.96 14.615a1.27 1.27 0 0 0-1.111-.647c-.47-.047-.875.236-1.106.634l-2.754 4.781c-.232.4-.231.879 0 1.28.232.4.645.639 1.107.639h5.474c.46 0 .873-.238 1.105-.636.233-.401.235-.879.007-1.281z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystAirplayBold;
