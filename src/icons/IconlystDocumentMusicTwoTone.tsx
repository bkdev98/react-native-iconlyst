...
const IconlystDocumentMusicTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M13.081 15.107a1.756 1.756 0 1 1-3.511 0 1.756 1.756 0 0 1 3.511 0"
      clipRule="evenodd"
      opacity={0.4}
    />
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M13.081 15.109v-5.27s.457 1.187 1.684 1.437"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
...
export default IconlystDocumentMusicTwoTone;
