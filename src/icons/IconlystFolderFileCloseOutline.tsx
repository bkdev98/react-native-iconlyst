...
const IconlystFolderFileCloseOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.929 10.874a.75.75 0 0 1 1.06 0l1.261 1.26 1.26-1.26a.75.75 0 1 1 1.06 1.062l-1.26 1.26 1.26 1.258a.75.75 0 0 1-1.061 1.06l-1.259-1.258-1.26 1.26a.75.75 0 0 1-1.06-1.06l1.26-1.26-1.261-1.261a.75.75 0 0 1 0-1.061"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileCloseOutline;
