...
const IconlystFolderFileFontOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.412 11.164v.657a.75.75 0 0 1-1.5 0v-.938c0-.671.545-1.219 1.22-1.219h4.687c.675 0 1.22.548 1.22 1.22v.937a.75.75 0 0 1-1.5 0v-.657h-1.315v4.126h.658a.75.75 0 1 1 0 1.5h-2.813a.75.75 0 1 1 0-1.5h.655v-4.126z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileFontOutline;
