...
const IconlystDownLeftLayoutOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.643 13.496a.75.75 0 0 1 .75-.75h7.297a.75.75 0 0 1 0 1.5H7.393a.75.75 0 0 1-.75-.75m0 4.379a.75.75 0 0 1 .75-.75h3.368a.75.75 0 0 1 0 1.5H7.393a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDownLeftLayoutOutline;
