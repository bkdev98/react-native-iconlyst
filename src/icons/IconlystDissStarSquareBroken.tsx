...
const IconlystDissStarSquareBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M12 3h4.217C19.165 3 21 5.081 21 8.026v7.948C21 18.919 19.165 21 16.216 21H7.782C4.834 21 3 18.919 3 15.974V8.026C3 5.081 4.843 3 7.782 3h.472"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystDissStarSquareBroken;
