...
const IconlystLockAiTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M16.448 9.458V7.362a4.448 4.448 0 0 0-8.897-.02v2.116"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
...
export default IconlystLockAiTwoTone;
