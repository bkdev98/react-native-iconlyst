...
const IconlystEqual1Bulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M9.392 9.096a.75.75 0 1 0 0 1.5h5.219a.75.75 0 0 0 0-1.5zM9.392 13.405a.75.75 0 0 0 0 1.5h5.219a.75.75 0 0 0 0-1.5z"
    />
  </Svg>
);
export default IconlystEqual1Bulk;
