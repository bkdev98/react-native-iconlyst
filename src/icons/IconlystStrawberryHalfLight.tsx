...
const IconlystStrawberryHalfLight = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M15.026 19.764c1.972-1.972 3.179-4.523 3.178-7.344 0-2.068-1.73-3.811-3.81-3.811H9.606c-2.08-.001-3.812 1.743-3.811 3.81 0 2.821 1.206 5.37 3.178 7.343 1.647 1.65 4.403 1.65 6.052.002"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
...
export default IconlystStrawberryHalfLight;
