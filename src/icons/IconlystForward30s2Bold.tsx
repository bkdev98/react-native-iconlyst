...
const IconlystForward30s2Bold = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.93 14.01a.6.6 0 0 1-.599-.6.75.75 0 0 0-1.5 0c0 1.158.942 2.1 2.098 2.1a2.1 2.1 0 0 0 2.1-2.1 2.1 2.1 0 0 0-.494-1.35A2.1 2.1 0 0 0 8.93 8.611a2.1 2.1 0 0 0-2.099 2.1.75.75 0 0 0 1.5 0 .598.598 0 1 1 .599.6.75.75 0 0 0 0 1.5.6.6 0 0 1 0 1.2M14.677 13.14c0 .458-.368.83-.82.83a.827.827 0 0 1-.823-.83v-2.16a.822.822 0 0 1 1.643 0zm-.82-4.48a2.323 2.323 0 0 0-2.323 2.32v2.16a2.33 2.33 0 0 0 2.322 2.33 2.33 2.33 0 0 0 2.321-2.33v-2.16a2.323 2.323 0 0 0-2.32-2.32"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystForward30s2Bold;
