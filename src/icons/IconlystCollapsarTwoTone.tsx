...
const IconlystCollapsarTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M3.37 7.552v-.058m-.008-.169a.25.25 0 1 0 .003.497.25.25 0 0 0-.003-.497"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M20.872 16.444v-.057m-.008-.17a.25.25 0 1 0 .003.497.25.25 0 0 0-.003-.497"
    />
  </Svg>
);
export default IconlystCollapsarTwoTone;
