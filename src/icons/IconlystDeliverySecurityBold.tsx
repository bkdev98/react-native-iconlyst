...
const IconlystDeliverySecurityBold = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M11.574 8.569a.75.75 0 0 1 .467-.001l1.848.6-.012-6.801a.3.3 0 0 0-.301-.3l-3.574.008a.3.3 0 0 0-.3.3l.008 6.809z"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
