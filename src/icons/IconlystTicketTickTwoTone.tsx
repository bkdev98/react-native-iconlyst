...
const IconlystTicketTickTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m13.895 9.55 1.763 1.764M10.135 5.813l1.737 1.737M16.407 16.68l1.465 1.466 2.947-2.947"
    />
  </Svg>
);
export default IconlystTicketTickTwoTone;
