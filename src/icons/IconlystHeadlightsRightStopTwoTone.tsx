...
const IconlystHeadlightsRightStopTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M21.25 6.5h-4.5M21.25 10.5h-4.5M21.25 14.5h-4.5M21.25 18.5h-4.5M19 19.492a6.35 6.35 0 0 0 0-6.992 6.35 6.35 0 0 1 0-6.992"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystHeadlightsRightStopTwoTone;
