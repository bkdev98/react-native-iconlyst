...
const IconlystCarEnergyLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="m17.55 13.353-2.91 4.01a.432.432 0 0 0 .35.686h2.38v2.518c0 .418.538.593.784.253l2.911-4.009a.433.433 0 0 0-.35-.687h-2.382v-2.517a.433.433 0 0 0-.782-.255"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
...
export default IconlystCarEnergyLight;
