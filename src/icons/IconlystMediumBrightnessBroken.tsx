...
const IconlystMediumBrightnessBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M16.012 12.138a3.5 3.5 0 0 1-3.502 3.501V8.637a3.5 3.5 0 0 1 2.476 1.025"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystMediumBrightnessBroken;
