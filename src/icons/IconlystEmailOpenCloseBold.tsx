...
const IconlystEmailOpenCloseBold = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M18.405 8.87a.75.75 0 0 0-1.06 0l-.57.568-.57-.569a.749.749 0 1 0-1.06 1.061l.57.57-.47.47a.749.749 0 1 0 1.06 1.06l.47-.47.47.47a.75.75 0 0 0 1.06 0 .75.75 0 0 0 0-1.06l-.47-.47.57-.57a.75.75 0 0 0 0-1.06"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystEmailOpenCloseBold;
