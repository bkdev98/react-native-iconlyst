...
const IconlystGoogleSlidesOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.223 12.031c0-.966.783-1.75 1.75-1.75h6.054c.966 0 1.75.784 1.75 1.75v4.634a1.75 1.75 0 0 1-1.75 1.75H8.973a1.75 1.75 0 0 1-1.75-1.75zm1.75-.25a.25.25 0 0 0-.25.25v4.634c0 .138.112.25.25.25h6.054a.25.25 0 0 0 .25-.25v-4.634a.25.25 0 0 0-.25-.25z"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.223 15.336a.75.75 0 0 1 .75-.75h8.054a.75.75 0 0 1 0 1.5H7.973a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystGoogleSlidesOutline;
