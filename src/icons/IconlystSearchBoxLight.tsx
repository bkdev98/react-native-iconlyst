...
const IconlystSearchBoxLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M20.899 11.417A8.417 8.417 0 0 0 12.482 3a8.418 8.418 0 1 0 8.417 8.417M18.21 17.583 21.637 21"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m9.3 9.603 3.331 1.926 3.33-1.926M12.635 15.404v-3.877"
    />
  </Svg>
);
export default IconlystSearchBoxLight;
