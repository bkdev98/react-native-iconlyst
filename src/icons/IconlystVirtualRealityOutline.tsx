...
const IconlystVirtualRealityOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M11.74 8.66a.75.75 0 0 1 .404.98L9.94 14.938a.75.75 0 0 1-1.384 0L6.349 9.64a.75.75 0 0 1 1.385-.577l1.513 3.635 1.512-3.634a.75.75 0 0 1 .98-.405M13.172 9.258a.75.75 0 0 1 .75-.75h1.893a2.395 2.395 0 0 1 0 4.79h-1.143v1.444a.75.75 0 0 1-1.5 0zm1.5 2.54h1.143a.895.895 0 0 0 0-1.79h-1.143z"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.27 11.908a.75.75 0 0 1 1.03.252l1.33 2.192a.75.75 0 0 1-1.283.778l-1.33-2.192a.75.75 0 0 1 .252-1.03"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystVirtualRealityOutline;
