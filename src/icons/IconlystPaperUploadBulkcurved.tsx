...
const IconlystPaperUploadBulkcurved = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M13.24 13.584a.749.749 0 0 0 .531-1.279L11.427 9.95a.747.747 0 0 0-1.064 0l-2.345 2.355a.75.75 0 0 0 1.063 1.059l1.064-1.07v4.225a.75.75 0 0 0 1.5 0v-4.224l1.064 1.069c.146.147.338.22.53.22"
    />
  </Svg>
);
export default IconlystPaperUploadBulkcurved;
