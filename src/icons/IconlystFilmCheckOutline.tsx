...
const IconlystFilmCheckOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.3 11.606a.75.75 0 0 1 0 1.06l-3.616 3.62a.75.75 0 0 1-1.061 0l-1.755-1.759a.75.75 0 1 1 1.061-1.06l1.225 1.227 3.085-3.087a.75.75 0 0 1 1.06 0M9.108 2.25a.75.75 0 0 1 .75.75v3.726h4.453V3a.75.75 0 0 1 1.5 0v3.726h4.816a.75.75 0 0 1 0 1.5H3.54a.75.75 0 1 1 0-1.5h4.817V3a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFilmCheckOutline;
