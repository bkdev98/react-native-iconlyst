...
const IconlystEmailRemoveCloseBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="m21.705 19.594-1.47-1.47 1.37-1.369a.749.749 0 1 0-1.06-1.06l-1.37 1.37-1.37-1.37a.75.75 0 0 0-1.06 1.06l1.37 1.37-1.47 1.47a.75.75 0 1 0 1.06 1.06l1.47-1.47 1.47 1.47a.75.75 0 1 0 1.06-1.06M13.275 12.725q-.75.6-1.8.6-.9 0-1.8-.6l-4-3.3c-.3-.3-.4-.7-.1-1.1s.7-.4 1.1-.1l4 3.2c.5.4 1.2.4 1.6 0l4-3.2c.3-.3.8-.2 1.1.1.3.5.2.9-.1 1.2z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystEmailRemoveCloseBulk;
