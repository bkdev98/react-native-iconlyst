...
const IconlystAiBrainFlashTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M6.91 2.682 3.96 6.746a.438.438 0 0 0 .354.696h2.414v2.551c0 .425.544.602.793.258l2.95-4.064a.439.439 0 0 0-.354-.696H7.703V2.939a.438.438 0 0 0-.793-.257"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystAiBrainFlashTwoTone;
