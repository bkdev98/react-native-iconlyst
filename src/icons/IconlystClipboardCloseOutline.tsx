...
const IconlystClipboardCloseOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10 11.146a.75.75 0 0 1 1.062 0l1.188 1.188 1.187-1.188a.75.75 0 0 1 1.06 1.061l-1.187 1.187 1.187 1.187a.75.75 0 1 1-1.06 1.06l-1.187-1.186-1.188 1.188a.75.75 0 0 1-1.06-1.061l1.187-1.188-1.188-1.188a.75.75 0 0 1 0-1.06"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystClipboardCloseOutline;
