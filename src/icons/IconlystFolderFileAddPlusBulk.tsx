...
const IconlystFolderFileAddPlusBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.297 13.946h-1.546v1.547a.75.75 0 0 1-1.5 0v-1.548H9.702a.75.75 0 0 1 0-1.5h1.549v-1.547a.75.75 0 0 1 1.5 0v1.547h1.546a.75.75 0 0 1 0 1.5"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileAddPlusBulk;
