...
const IconlystPoopMoodyLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M11.02 15.747c.49.637 1.21 1.034 2.01 1.034M10.32 12.423c.185.121.458.196.76.196s.574-.075.76-.196M14.139 12.423c.184.121.457.196.759.196s.575-.075.76-.196"
    />
  </Svg>
);
export default IconlystPoopMoodyLight;
