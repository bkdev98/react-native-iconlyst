...
const IconlystLinuxTwoTone = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M10.605 7.813v1.785M13.396 7.813v1.785"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M14.857 17.927A9.34 9.34 0 0 0 14 11.34M10 11.34a9.34 9.34 0 0 0-.856 6.587"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
...
export default IconlystLinuxTwoTone;
