...
const IconlystChatHouseBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M17.814 11.237a.745.745 0 0 1-1.054.12l-.284-.225v2.482a.75.75 0 0 1-1.5 0V9.94l-2.333-1.854a.544.544 0 0 0-.68 0L9.626 9.943v3.67a.75.75 0 0 1-1.5 0v-2.478l-.282.223a.75.75 0 1 1-.933-1.175l4.119-3.271a2.04 2.04 0 0 1 2.546 0l4.118 3.27a.75.75 0 0 1 .12 1.055"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystChatHouseBulk;
