...
const IconlystFolderFileAnalysisOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M16.441 10.747a.75.75 0 0 1 .133 1.052l-2.2 2.84a.75.75 0 0 1-1.056.13l-1.968-1.546-1.787 2.322a.75.75 0 0 1-1.189-.915l2.249-2.922a.75.75 0 0 1 1.057-.132l1.97 1.547 1.739-2.243a.75.75 0 0 1 1.052-.133"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileAnalysisOutline;
