...
const IconlystFilterEditBulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M10.723 9.105a1.32 1.32 0 0 1-.408-1.107l.082-.76c.052-.474.247-.912.564-1.267l3.215-3.51a1.517 1.517 0 0 1 2.139-.085l.678.628c.296.274.468.647.483 1.051s-.127.79-.402 1.086L13.9 8.604a2.26 2.26 0 0 1-1.312.721l-.736.123a1.315 1.315 0 0 1-1.129-.343"
    />
  </Svg>
);
export default IconlystFilterEditBulk;
