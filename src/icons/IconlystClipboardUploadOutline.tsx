...
const IconlystClipboardUploadOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M11.5 12.423v3.62a.75.75 0 0 0 1.5 0V12.42l.83.834a.75.75 0 0 0 1.063-1.059l-2.11-2.119a.75.75 0 0 0-.532-.22h-.001a.75.75 0 0 0-.554.244l-2.087 2.095a.75.75 0 0 0 1.063 1.059z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystClipboardUploadOutline;
