...
const IconlystShoppingBagDiscountOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.426 7.025A4.795 4.795 0 0 1 12.24 2.25a4.795 4.795 0 0 1 4.794 4.795.75.75 0 0 1-1.5 0A3.295 3.295 0 0 0 12.24 3.75h-.004a3.295 3.295 0 0 0-3.31 3.28v.015a.75.75 0 0 1-1.5 0zM15.118 10.985a.75.75 0 0 1 0 1.061l-4.677 4.678a.75.75 0 0 1-1.061-1.06l4.678-4.679a.75.75 0 0 1 1.06 0M13.775 16.125a.75.75 0 0 1 .75-.75h.034a.75.75 0 0 1 0 1.5h-.034a.75.75 0 0 1-.75-.75M9.225 11.578a.75.75 0 0 1 .75-.75h.024a.75.75 0 0 1 0 1.5h-.024a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystShoppingBagDiscountOutline;
