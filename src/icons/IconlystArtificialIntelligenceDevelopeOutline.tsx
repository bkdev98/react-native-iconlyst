...
const IconlystArtificialIntelligenceDevelopeOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.55 9.755a.75.75 0 0 1 1.06 0l1.715 1.714a.75.75 0 0 1 0 1.06l-1.714 1.715a.75.75 0 0 1-1.06-1.06L15.733 12l-1.184-1.184a.75.75 0 0 1 0-1.061M9.45 9.755a.75.75 0 0 0-1.06 0l-1.715 1.714a.75.75 0 0 0 0 1.06l1.714 1.715a.75.75 0 1 0 1.06-1.06L8.267 12l1.184-1.184a.75.75 0 0 0 0-1.061M13.18 8.558a.75.75 0 0 1 .467.953l-1.875 5.464a.75.75 0 0 1-1.419-.487l1.875-5.464a.75.75 0 0 1 .953-.466"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystArtificialIntelligenceDevelopeOutline;
