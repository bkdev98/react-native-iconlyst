...
const IconlystServerTransferOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.863 16.136a.75.75 0 0 1 .75-.75h.523a.75.75 0 0 1 0 1.5h-.523a.75.75 0 0 1-.75-.75M6.863 7.865a.75.75 0 0 1 .75-.75h.523a.75.75 0 1 1 0 1.5h-.523a.75.75 0 0 1-.75-.75m4.739 0a.75.75 0 0 1 .75-.75h4.534a.75.75 0 0 1 0 1.5h-4.534a.75.75 0 0 1-.75-.75M2.523 12a.75.75 0 0 1 .75-.75h9.197a.75.75 0 0 1 0 1.5H3.273a.75.75 0 0 1-.75-.75M15.97 14.176a.75.75 0 0 1 .409.668V21a.75.75 0 0 1-1.5 0v-4.687l-1.004.726a.75.75 0 1 1-.88-1.215l2.194-1.588a.75.75 0 0 1 .78-.06M19.057 14.095a.75.75 0 0 1 .75.75v4.686l1.003-.726a.75.75 0 0 1 .88 1.215l-2.194 1.587a.75.75 0 0 1-1.19-.607v-6.155a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystServerTransferOutline;
