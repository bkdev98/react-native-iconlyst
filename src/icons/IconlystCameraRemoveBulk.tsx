...
const IconlystCameraRemoveBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M20.25 7.212a.5.5 0 0 0-.69.047l-4.837 5.302a.5.5 0 0 0-.131.337 2.596 2.596 0 0 1-2.593 2.593.5.5 0 0 0-.362.156l-3.473 3.66a.498.498 0 0 0 .362.844h8.368a4.61 4.61 0 0 0 4.606-4.606V9.902a3.5 3.5 0 0 0-1.25-2.69"
      clipRule="evenodd"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystCameraRemoveBulk;
