...
const IconlystDecredOutline = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.615 7.674a.75.75 0 0 1 1.06.034l2.401 2.56a.75.75 0 0 1-.547 1.264h-1.5a1.75 1.75 0 1 0 0 3.498h1.5a.75.75 0 0 1 0 1.5h-1.5a3.25 3.25 0 0 1-.224-6.49L8.58 8.733a.75.75 0 0 1 .034-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.223 8.22a.75.75 0 0 1 .75-.75h1.5a3.25 3.25 0 0 1 .224 6.491l1.224 1.306a.75.75 0 0 1-1.094 1.026l-2.401-2.561a.75.75 0 0 1 .547-1.263h1.5a1.75 1.75 0 1 0 0-3.498h-1.5a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDecredOutline;
