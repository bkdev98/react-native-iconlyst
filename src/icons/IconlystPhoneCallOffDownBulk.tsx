...
const IconlystPhoneCallOffDownBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="m14.487 15.875-1.237 1.243v-4.454a.75.75 0 0 0-1.5 0v4.453l-1.237-1.242a.749.749 0 1 0-1.062 1.06l2.516 2.527q.105.106.245.164a.7.7 0 0 0 .222.045c.022.002.042.014.066.014.1 0 .2-.02.29-.059.055-.023.098-.063.145-.097.031-.023.07-.037.097-.065l2.517-2.53a.75.75 0 1 0-1.062-1.059"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystPhoneCallOffDownBulk;
