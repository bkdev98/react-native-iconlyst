...
const IconlystThumbDislikeSquareTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
...
export default IconlystThumbDislikeSquareTwoTone;
