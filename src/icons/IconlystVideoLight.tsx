...
const IconlystVideoLight = ({
  ...
  >
    ...
    >
      ...
      <Path d="m16.3 9.98 3.293-2.695c.816-.668 2.04-.086 2.039.967L21.62 15.6c-.001 1.053-1.226 1.63-2.04.962l-3.28-2.695" />
    </G>
  </Svg>
);
export default IconlystVideoLight;
