...
const IconlystTruck2Bulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      d="M8.96 8.22H5.39a.749.749 0 1 1 0-1.5h3.57a.749.749 0 1 1 0 1.5M6.732 10.61h-4.57a.749.749 0 1 1 0-1.5h4.57a.749.749 0 1 1 0 1.5"
    />
  </Svg>
);
export default IconlystTruck2Bulk;
