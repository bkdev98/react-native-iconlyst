...
const IconlystEmailOpenCloseBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M18.405 8.87a.75.75 0 0 0-1.061 0l-.569.568-.57-.569a.749.749 0 1 0-1.06 1.061l.569.57-.47.47a.749.749 0 1 0 1.061 1.06l.47-.47.469.47a.75.75 0 0 0 1.061 0 .75.75 0 0 0 0-1.06l-.47-.47.57-.57a.75.75 0 0 0 0-1.06"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystEmailOpenCloseBulk;
