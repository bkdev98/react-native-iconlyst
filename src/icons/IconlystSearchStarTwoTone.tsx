...
const IconlystSearchStarTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M20.169 12.756a8.18 8.18 0 1 1-9.128-9.183"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
