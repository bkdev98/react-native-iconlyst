...
const IconlystPaperDownloadOutlinecurved = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.184 2.083a.75.75 0 0 1 .75.75v2.66a2.613 2.613 0 0 0 2.614 2.614H20.5a.75.75 0 0 1 0 1.5h-2.95a4.113 4.113 0 0 1-4.115-4.113V2.833a.75.75 0 0 1 .75-.75M11.91 9.226a.75.75 0 0 1 .75.75v6.041a.75.75 0 0 1-1.5 0v-6.04a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.036 13.13a.75.75 0 0 1 1.06.003l1.814 1.821 1.813-1.821a.75.75 0 0 1 1.063 1.058l-2.345 2.355a.75.75 0 0 1-1.063 0l-2.345-2.355a.75.75 0 0 1 .003-1.06"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystPaperDownloadOutlinecurved;
