...
const IconlystDownCenterLayoutOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.102 13.496a.75.75 0 0 1 .75-.75h7.297a.75.75 0 0 1 0 1.5H8.852a.75.75 0 0 1-.75-.75m1.683 4.379a.75.75 0 0 1 .75-.75h3.368a.75.75 0 1 1 0 1.5h-3.368a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystDownCenterLayoutOutline;
