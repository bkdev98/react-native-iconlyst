...
const IconlystForward30s2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M6.008 10.71a2.097 2.097 0 1 1 3.706 1.349 2.098 2.098 0 1 1-3.706 1.348.75.75 0 0 1 1.5 0 .598.598 0 1 0 .598-.598.75.75 0 0 1 0-1.5.598.598 0 1 0-.598-.598.75.75 0 0 1-1.5 0M13.032 10.156a.82.82 0 0 0-.821.822v2.167a.821.821 0 0 0 1.643 0v-2.167a.82.82 0 0 0-.822-.822m-2.321.822a2.321 2.321 0 1 1 4.643 0v2.167a2.321 2.321 0 1 1-4.643 0zM21.614 9.935a.75.75 0 0 1 0 1.06l-1.652 1.652a.75.75 0 0 1-1.06 0l-1.643-1.642a.75.75 0 1 1 1.06-1.06l1.113 1.111 1.121-1.121a.75.75 0 0 1 1.06 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystForward30s2Outline;
