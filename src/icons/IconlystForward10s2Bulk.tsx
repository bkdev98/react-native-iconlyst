...
const IconlystForward10s2Bulk = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M8.322 9.443v5.12a.75.75 0 0 0 1.5 0v-5.12a.75.75 0 0 0-1.5 0M14.062 10.924v2.16a.82.82 0 0 1-1.643 0v-2.16c0-.458.37-.83.822-.83.453 0 .821.372.821.83m-3.143 0v2.16a2.322 2.322 0 0 0 4.643 0v-2.16a2.33 2.33 0 0 0-2.32-2.33 2.33 2.33 0 0 0-2.323 2.33"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystForward10s2Bulk;
