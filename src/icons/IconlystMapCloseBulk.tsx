...
const IconlystMapCloseBulk = ({
  ...
  >
    ...
    <G fill={props.color} fillRule="evenodd" clipRule="evenodd" opacity={0.4}>
      <Path d="M20.938 3.241c-.51-.33-1.15-.38-1.71-.13l-2.993 1.327-.067.103v6.97c.85-.36 1.79-.56 2.78-.56a7.2 7.2 0 0 1 2.068.303.567.567 0 0 0 .732-.545V4.751c0-.61-.3-1.17-.81-1.51M7.685 2.734 3.836 4.435a2.67 2.67 0 0 0-1.584 2.44v12.663a1.79 1.79 0 0 0 2.522 1.64l2.998-1.333a.11.11 0 0 0 .065-.1V2.835a.11.11 0 0 0-.152-.101" />
    </G>
    <Path
      fill={props.color}
      fillRule="evenodd"
...
export default IconlystMapCloseBulk;
