...
const IconlystRingtonePlayingBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M14.46 19.092h-4.24a.752.752 0 0 0-.584 1.219 3.45 3.45 0 0 0 2.7 1.316 3.46 3.46 0 0 0 2.71-1.317.75.75 0 0 0-.585-1.218"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystRingtonePlayingBulk;
