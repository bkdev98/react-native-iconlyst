...
const IconlystFlashSwapBold = ({
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="m12.572 13.044-1.247 2.294a.75.75 0 1 0 1.317.717l1.85-3.403a.748.748 0 0 0-.658-1.108h-2.42l1.248-2.292a.749.749 0 1 0-1.317-.716l-1.851 3.4a.748.748 0 0 0 .659 1.108z"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystFlashSwapBold;
