...
const IconlystGrinningFaceOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.886 8.496a.75.75 0 0 1 .75-.75h1.592a.75.75 0 0 1 0 1.5H8.635a.75.75 0 0 1-.75-.75m5.636 0a.75.75 0 0 1 .75-.75h1.592a.75.75 0 0 1 0 1.5h-1.592a.75.75 0 0 1-.75-.75M7.886 12.914a.75.75 0 0 1 .75-.75h7.229a.75.75 0 0 1 .75.75c0 2.508-1.903 4.637-4.365 4.637-2.46 0-4.364-2.129-4.364-4.637m1.581.75c.312 1.4 1.475 2.387 2.783 2.387 1.309 0 2.472-.987 2.784-2.387z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystGrinningFaceOutline;
