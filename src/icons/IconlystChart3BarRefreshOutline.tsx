...
const IconlystChart3BarRefreshOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M19.09 3.368a2.5 2.5 0 1 0 2.141 3.794.75.75 0 1 1 1.283.778A4 4 0 0 1 15.09 5.87a4 4 0 0 1 7.576-1.798.75.75 0 0 1-1.34.675 2.5 2.5 0 0 0-2.235-1.378"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M21.995 1.868a.75.75 0 0 1 .75.75v1.79a.75.75 0 0 1-.75.75h-1.8a.75.75 0 1 1 0-1.5h1.05v-1.04a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystChart3BarRefreshOutline;
