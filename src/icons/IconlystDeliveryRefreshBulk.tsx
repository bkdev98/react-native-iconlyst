...
const IconlystDeliveryRefreshBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.11 8.726a.75.75 0 0 1 .466-.001l1.848.601-.012-6.802a.3.3 0 0 0-.3-.3l-3.575.008a.3.3 0 0 0-.3.3l.008 6.809zM18.768 13.568c-.825 0-1.603.248-2.261.686a.744.744 0 0 0-1.487.064v1.85c0 .049.019.093.028.14.008.038.01.076.023.114.02.056.054.104.087.154.02.032.036.064.06.09a.7.7 0 0 0 .15.117c.024.016.04.04.067.053.006.004.013.003.019.006.05.024.105.032.16.044.045.01.088.024.132.027.009 0 .016.005.024.005h1.856a.75.75 0 0 0 0-1.5h-.14c.384-.22.82-.35 1.282-.35a2.604 2.604 0 0 1 0 5.21 2.59 2.59 0 0 1-2.228-1.26.75.75 0 1 0-1.283.779 4.08 4.08 0 0 0 3.51 1.98 4.105 4.105 0 0 0 4.103-4.1 4.11 4.11 0 0 0-4.102-4.11"
      clipRule="evenodd"
    />
  </Svg>
);
