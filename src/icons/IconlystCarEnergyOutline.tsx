...
const IconlystCarEnergyOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M13.57 11.049a.75.75 0 0 1 .75-.75h1.573a.75.75 0 0 1 0 1.5h-1.572a.75.75 0 0 1-.75-.75M5.801 11.049a.75.75 0 0 1 .75-.75h1.573a.75.75 0 0 1 0 1.5H6.55a.75.75 0 0 1-.75-.75M2.613 7.28a.75.75 0 0 1 .848-.638c5.146.73 10.368.73 15.514 0a.75.75 0 1 1 .21 1.485c-5.285.75-10.65.75-15.934 0a.75.75 0 0 1-.638-.848"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
    ...
    <Path
      fill={props.color}
      d="M17.81 21.761c-.12 0-.25-.02-.37-.06-.49-.16-.82-.61-.82-1.13v-1.77h-1.63c-.45 0-.85-.25-1.05-.65s-.17-.87.1-1.23l2.91-4.01c.3-.42.83-.59 1.32-.43s.82.61.82 1.12v1.77h1.63c.45 0 .85.25 1.05.65s.17.87-.1 1.23l-2.91 4.01c-.23.31-.58.49-.96.49zm-2.19-4.45h1.76c.41 0 .75.34.75.75v1.54l1.97-2.72h-1.76c-.41 0-.75-.34-.75-.75v-1.54z"
    />
  </Svg>
);
export default IconlystCarEnergyOutline;
