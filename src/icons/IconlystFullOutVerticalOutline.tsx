...
const IconlystFullOutVerticalOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.977 5.222a.75.75 0 0 1 .75.75v4a.75.75 0 0 1-1.5 0v-2.19l-2.72 2.72a.75.75 0 0 1-1.06-1.06l2.719-2.72h-2.19a.75.75 0 1 1 0-1.5zM7.977 18.722a.75.75 0 0 1-.75-.75v-4a.75.75 0 0 1 1.5 0v2.189l2.72-2.72a.75.75 0 0 1 1.06 1.061l-2.72 2.72h2.19a.75.75 0 0 1 0 1.5z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFullOutVerticalOutline;
