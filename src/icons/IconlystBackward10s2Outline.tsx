...
const IconlystBackward10s2Outline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M2.554 9.935a.75.75 0 0 1 1.06 0l1.122 1.121 1.112-1.112a.75.75 0 0 1 1.06 1.06l-1.642 1.643a.75.75 0 0 1-1.06 0l-1.652-1.652a.75.75 0 0 1 0-1.06M10.207 8.691a.75.75 0 0 1 .75.75v5.115a.75.75 0 0 1-1.5 0V9.441a.75.75 0 0 1 .75-.75M14.376 10.094a.82.82 0 0 0-.821.822v2.166a.821.821 0 1 0 1.642 0v-2.166a.82.82 0 0 0-.82-.822m-2.321.822a2.321 2.321 0 1 1 4.642 0v2.166a2.321 2.321 0 1 1-4.642 0z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystBackward10s2Outline;
