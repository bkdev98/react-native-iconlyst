...
const IconlystShoppingBasketPlusOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.56 14.883a.75.75 0 0 1 .75-.75h3.963a.75.75 0 1 1 0 1.5H10.31a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.293 12.148a.75.75 0 0 1 .75.75v3.963a.75.75 0 0 1-1.5 0v-3.963a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.11 3.65a2.644 2.644 0 0 1 4.21 0l3.78 4.972a.75.75 0 1 1-1.195.908l-3.78-4.973a1.144 1.144 0 0 0-1.821 0L7.524 9.53a.75.75 0 0 1-1.193-.908z"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystShoppingBasketPlusOutline;
