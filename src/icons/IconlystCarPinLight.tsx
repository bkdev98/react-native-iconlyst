...
const IconlystCarPinLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M15.147 12.234a2.448 2.448 0 1 0-3.463-3.464M10.812 17.304h.577M5.623 17.304h.578M3.25 14.858c3.482.494 7.017.494 10.5 0"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystCarPinLight;
