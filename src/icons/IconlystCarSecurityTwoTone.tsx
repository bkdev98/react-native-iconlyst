...
const IconlystCarSecurityTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M14.505 11.805h1.613M6.53 11.805h1.614M3.25 8.044a57.5 57.5 0 0 0 16.14 0"
      opacity={0.4}
    />
    <Path
      stroke={props.color}
