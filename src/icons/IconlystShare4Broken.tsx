...
const IconlystShare4Broken = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M3 17.188a2.303 2.303 0 1 1 2.303 2.303M19.496 15.028v.009M21 17.187a2.303 2.303 0 1 0-2.302 2.304M10.37 4.071a2.303 2.303 0 1 0 3.258 0"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystShare4Broken;
