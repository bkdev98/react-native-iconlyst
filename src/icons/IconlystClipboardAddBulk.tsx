...
const IconlystClipboardAddBulk = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.81 5.48h4.38c.68 0 1.24-.54 1.26-1.22.01-.02.01-.04.01-.06v-.54c0-.7-.57-1.27-1.27-1.27H9.81c-.7 0-1.28.57-1.28 1.27v.54c0 .02 0 .03.01.05.02.69.59 1.23 1.27 1.23M14.21 14.608h-1.46v1.45c0 .42-.33.75-.75.75-.41 0-.75-.33-.75-.75v-1.45H9.8c-.42 0-.75-.34-.75-.75 0-.42.33-.75.75-.75h1.45v-1.46a.749.749 0 1 1 1.5 0v1.46h1.46a.749.749 0 1 1 0 1.5"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystClipboardAddBulk;
