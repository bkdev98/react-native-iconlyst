...
const IconlystPoopFunBroken = ({
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M10.576 12.111v.01M15.45 12.111v.01"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M14.636 15.008c0 .979-.738 1.773-1.649 1.773-.91 0-1.65-.794-1.65-1.773z"
      clipRule="evenodd"
    />
    <Path
      stroke={props.color}
...
export default IconlystPoopFunBroken;
