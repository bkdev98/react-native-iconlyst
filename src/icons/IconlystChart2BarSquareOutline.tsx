...
const IconlystChart2BarSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M10.134 7.868a.75.75 0 0 1 .75.75v6.998a.75.75 0 0 1-1.5 0V8.618a.75.75 0 0 1 .75-.75m4.733 3.471a.75.75 0 0 1 .75.75v3.527a.75.75 0 0 1-1.5 0V12.09a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystChart2BarSquareOutline;
