...
const IconlystFolderFileZipOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.598 5.117a.75.75 0 0 1 .75.75v1.526a.75.75 0 0 1-1.5 0V5.867a.75.75 0 0 1 .75-.75m0 4.53a.75.75 0 0 1 .75.75v1.527a.75.75 0 1 1-1.5 0v-1.526a.75.75 0 0 1 .75-.75m0 4.533a.75.75 0 0 1 .75.75v1.525a.75.75 0 0 1-1.5 0V14.93a.75.75 0 0 1 .75-.75m0 4.531a.75.75 0 0 1 .75.75v1.526a.75.75 0 0 1-1.5 0V19.46a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystFolderFileZipOutline;
