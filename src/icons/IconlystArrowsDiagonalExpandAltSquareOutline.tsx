...
const IconlystArrowsDiagonalExpandAltSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.5 6.75h4.154a.75.75 0 1 1 0 1.5H9.31l6.439 6.44v-2.344a.75.75 0 1 1 1.5 0V16.5a.75.75 0 0 1-.75.75h-4.154a.75.75 0 1 1 0-1.5h2.343L8.25 9.31v2.344a.75.75 0 1 1-1.5 0V7.5a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
...
export default IconlystArrowsDiagonalExpandAltSquareOutline;
