...
const IconlystEyeAiLight = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="m10.302 13.726-.088-.238a3.28 3.28 0 0 0-1.938-1.942l-.238-.088.238-.088a3.28 3.28 0 0 0 1.938-1.941l.088-.239.088.239c.333.899 1.04 1.608 1.939 1.94l.238.089-.238.088a3.28 3.28 0 0 0-1.939 1.942zM14.936 14.81a1.54 1.54 0 0 0-1.027-1.028c.492-.15.877-.536 1.027-1.029.15.493.535.879 1.027 1.029-.492.15-.877.535-1.027 1.028"
    />
  </Svg>
);
export default IconlystEyeAiLight;
