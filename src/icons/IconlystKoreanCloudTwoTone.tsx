...
const IconlystKoreanCloudTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M6.879 17.75c-1.217-.096-2.385.385-3.531.995"
      opacity={0.4}
    />
  </Svg>
);
export default IconlystKoreanCloudTwoTone;
