...
const IconlystShoppingBagPlusOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M7.426 7.024A4.796 4.796 0 0 1 12.24 2.25a4.795 4.795 0 0 1 4.794 4.795.75.75 0 0 1-1.5 0A3.295 3.295 0 0 0 12.24 3.75h-.004a3.296 3.296 0 0 0-3.31 3.28v.015a.75.75 0 0 1-1.5 0zM8.926 14.156a.75.75 0 0 1 .75-.75h5.153a.75.75 0 0 1 0 1.5H9.676a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.252 10.828a.75.75 0 0 1 .75.75v5.154a.75.75 0 0 1-1.5 0v-5.154a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystShoppingBagPlusOutline;
