...
const IconlystHeartPlusOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M9.314 11.594a.75.75 0 0 1 .75-.75h4.373a.75.75 0 1 1 0 1.5h-4.372a.75.75 0 0 1-.75-.75"
      clipRule="evenodd"
    />
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M12.25 8.656a.75.75 0 0 1 .75.75v4.373a.75.75 0 0 1-1.5 0V9.406a.75.75 0 0 1 .75-.75"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystHeartPlusOutline;
