...
const IconlystStrawberrysTwoTone = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <G
      ...
      opacity={0.4}
    >
      <Path d="M11.549 6.99a3.3 3.3 0 0 0-1.59.443l-3.687 2.13c-1.604.924-2.162 3.038-1.241 4.63 1.254 2.173 3.318 3.6 5.714 4.243.431.116.868.15 1.293.112M9.363 10.939l.25.249M7.257 12.6l.249.25M9.317 14.673l.25.25" />
      <Path d="M5.62 4.177c-.645 1.473-.087 2.491.273 2.816-.342-.192-1.4-.303-2.893.784.571.988 2.41 2.283 5.115.72 2.624-1.514 2.504-3.8 1.934-4.79-1.688.75-2.12 1.722-2.126 2.114-.101-.474-.703-1.467-2.302-1.644" />
    </G>
  </Svg>
);
export default IconlystStrawberrysTwoTone;
