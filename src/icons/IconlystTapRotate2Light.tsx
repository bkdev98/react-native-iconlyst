...
const IconlystTapRotate2Light = ({
  ...
  >
    ...
    <Path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M4.937 6.836V5.312H3.443"
    />
  </Svg>
);
export default IconlystTapRotate2Light;
