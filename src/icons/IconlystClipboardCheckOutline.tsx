...
const IconlystClipboardCheckOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      fill={props.color}
      fillRule="evenodd"
      d="M15.738 10.778a.75.75 0 0 1 0 1.06l-3.975 3.975a.75.75 0 0 1-1.06 0L8.76 13.871a.75.75 0 0 1 1.06-1.06l1.412 1.411 3.444-3.444a.75.75 0 0 1 1.06 0"
      clipRule="evenodd"
    />
  </Svg>
);
export default IconlystClipboardCheckOutline;
