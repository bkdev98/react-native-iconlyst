...
const IconlystMessagesQuestionBroken = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeWidth={1.5}
      d="M12.275 16.603v.007M12.274 14.355c-.01-.82.733-1.17 1.288-1.486.673-.373 1.131-.967 1.131-1.792A2.197 2.197 0 0 0 12.5 8.875a2.19 2.19 0 0 0-2.194 2.202"
    />
    <Path
      stroke={props.color}
      strokeLinecap="round"
...
export default IconlystMessagesQuestionBroken;
