...
const IconlystArrowsVerticalMaximizeSquareOutline = ({
  title,
  titleId,
  ...props
}: SvgProps & SVGRProps) => (
...
export default IconlystArrowsVerticalMaximizeSquareOutline;
